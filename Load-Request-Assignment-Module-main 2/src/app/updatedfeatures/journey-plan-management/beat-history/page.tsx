                    ...
                    <TableRow key={history.UID}>
                      ...
                      <TableCell>
                        <div className="space-y-1">
                          <div className="flex items-center gap-2">
                            ...
                            <span>{moment(history.VisitDate).format('DD/MM/YYYY')}</span>
                          </div>
                          <div className="text-sm text-muted-foreground">
                            {moment(history.VisitDate).format('dddd')}
                          </div>
                      ...
                      <TableCell>
                        <div className="space-y-1 text-sm">
                          ...
                          {history.StartTime && (
                            <div className="text-muted-foreground">
                              Actual: {moment(history.StartTime).format('HH:mm')} - {history.EndTime ? moment(history.EndTime).format('HH:mm') : 'In Progress'}
                            </div>
                          )}
                        </div>
                      </TableCell>
        ...
        <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              {selectedBeatHistory && (
                <>
                  {selectedBeatHistory.EmployeeName} - {selectedBeatHistory.RouteName} - {moment(selectedBeatHistory.VisitDate).format('DD MMMM YYYY')}
                </>
              )}
            </DialogDescription>
          </DialogHeader>
                          ...
                          <div className="flex-1">
                            ...
                            <div className="grid grid-cols-2 gap-4 text-sm">
                              <div>
                                ...
                                <div>
                                  {visit.LoginTime ? moment(visit.LoginTime).format('HH:mm') : '-'} - {visit.LogoutTime ? moment(visit.LogoutTime).format('HH:mm') : '-'}
                                </div>
                              </div>
                              <div>
