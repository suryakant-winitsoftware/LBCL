                    ...
                    <TableRow key={plan.UID} className={selectedPlans.includes(plan.UID) ? 'bg-blue-50' : ''}>
                      ...
                      <TableCell>
                        <div className="flex items-center gap-2">
                          ...
                          <span>{moment(plan.VisitDate).format('DD/MM/YYYY')}</span>
                        </div>
                        <div className="text-sm text-muted-foreground">
                          {moment(plan.VisitDate).format('dddd')}
                        </div>
                      </TableCell>
                      <TableCell>
                      ...
                      <TableCell>
                        <div className="space-y-1 text-sm">
                          ...
                          {plan.StartTime && (
                            <div className="text-muted-foreground">
                              Actual: {moment(plan.StartTime).format('HH:mm')} - {plan.EndTime ? moment(plan.EndTime).format('HH:mm') : 'In Progress'}
                            </div>
                          )}
                        </div>
                      </TableCell>
