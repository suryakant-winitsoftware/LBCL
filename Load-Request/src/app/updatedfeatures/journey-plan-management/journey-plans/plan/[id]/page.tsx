      ...
      <div className="flex items-center justify-between">
        <div className="space-y-1">
          ...
          <p className="text-muted-foreground">
            {moment(beatHistory.VisitDate).format('dddd, DD MMMM YYYY')} • {beatHistory.UID}
          </p>
        </div>
        <div className="flex gap-2">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        ...
                        <span className="font-medium">
                          {moment(beatHistory.VisitDate).format('DD MMMM YYYY')}
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        ...
                        <span>
                          {beatHistory.PlannedStartTime ? moment(beatHistory.PlannedStartTime).format('HH:mm') : '09:00'} - 
                          {beatHistory.PlannedEndTime ? moment(beatHistory.PlannedEndTime).format('HH:mm') : '18:00'}
                        </span>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        <Clock className="h-4 w-4" />
                        <span>
                          {beatHistory.StartTime ? moment(beatHistory.StartTime).format('HH:mm') : '--:--'} - 
                          {beatHistory.EndTime ? moment(beatHistory.EndTime).format('HH:mm') : '--:--'}
                        </span>
                      </div>
                    </div>
