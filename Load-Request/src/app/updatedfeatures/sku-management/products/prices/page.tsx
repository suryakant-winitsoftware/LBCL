...
import { Search, Filter, Download, Upload, DollarSign } from 'lucide-react'
...
export default function ProductPricesPage() {
  ...
  const handleEditPrice = (skuUID: string) => {
    router.push(`/updatedfeatures/sku-management/pricing/create?uid=${skuUID}`)
  }
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage pricing information for your products
          </p>
        </div>
                  ...
                  <TableRow key={sku.SKUUID}>
                    ...
                    <TableCell className="text-right">
                      <Button
                        variant="ghost"
                        size="sm"
                        onClick={() => handleEditPrice(sku.SKUUID)}
                      >
                        Edit Price
                      </Button>
                    </TableCell>
