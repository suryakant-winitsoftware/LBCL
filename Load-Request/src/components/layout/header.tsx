...
export function Header() {
  ...
  return (
    <>
    <header className="sticky top-0 z-50 flex h-14 shrink-0 items-center border-b border-gray-100 bg-white dark:border-gray-800 dark:bg-gray-950">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative hidden sm:flex items-center">
            ...
            <input
              type="text"
              placeholder="Search..."
              className="h-9 w-80 pl-10 pr-20 text-sm bg-gray-50 dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 placeholder:text-gray-400"
              onClick={() => setSearchOpen(true)}
              readOnly
            />
            <kbd className="absolute right-2.5 inline-flex h-5 select-none items-center gap-1 rounded border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 px-1.5 font-mono text-[10px] font-medium text-gray-500 dark:text-gray-400">
          ...
          <Button
            variant="ghost"
            size="sm"
            className="h-9 w-9 p-0 sm:hidden hover:bg-gray-100 dark:hover:bg-gray-800"
            onClick={() => setSearchOpen(true)}
          >
                ...
                <div className="sm:hidden">
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <span className="font-medium text-gray-700 dark:text-gray-300">Appearance</span>
                    </div>
                  </DropdownMenuItem>
                </div>
