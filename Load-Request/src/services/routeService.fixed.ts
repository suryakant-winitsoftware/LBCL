...
export const routeServiceFixed = {
  ...
  async createRouteMaster(data: RouteMasterData) {
    try {
      const response = await apiService.post('/api/Route/CreateRouteMaster', data);
      return response;
    } catch (error) {
  ...
  async updateRoute(routeData: any) {
    try {
      const response = await apiService.put('/api/Route/UpdateRouteDetails', routeData);
      return response;
    } catch (error) {
  ...
  async getRoutes(params: {
    ...
    try {
      const response = await apiService.post('/api/Route/SelectAllRouteDetails', {
  ...
  async getRouteByUID(uid: string) {
    try {
      const response = await apiService.get(`/api/Route/SelectRouteDetailByUID?UID=${uid}`);
      return response;
    } catch (error) {
  ...
  async deleteRoute(uid: string) {
    try {
      const response = await apiService.delete(`/api/Route/DeleteRouteDetail?UID=${uid}`);
      return response;
    } catch (error) {
  ...
  async getRouteMasterView(uid: string) {
    try {
      const response = await apiService.get(`/api/Route/SelectRouteMasterViewByUID?UID=${uid}`);
      return response;
    } catch (error) {
  ...
  async addCustomersToRoute(routeUID: string, customers: RouteCustomer[]) {
    try {
      ...
      try {
        // First try batch add
        const response = await apiService.post('/api/RouteCustomer/AddMultipleCustomers', {
          routeUID,
          customers
        });
        return response;
        ...
        for (const customer of customers) {
          try {
            const response = await apiService.post('/api/RouteCustomer/CreateRouteCustomerDetails', {
              routeUID,
  ...
  async getRouteCustomers(routeUID: string) {
    try {
      ...
      const response = await apiService.get(`/api/RouteCustomer/GetRouteCustomers?routeUID=${routeUID}`);
      return response?.data || response || [];
    } catch (error) {
      // Try alternative endpoint
      try {
        const response = await apiService.post('/api/RouteCustomer/SelectAllRouteCustomerDetails', {
          pageNumber: 1,
          pageSize: 100,
  ...
  async updateRouteCustomers(routeUID: string, customers: RouteCustomer[]) {
    try {
      ...
      const response = await apiService.put('/api/RouteCustomer/UpdateRouteCustomers', {
        routeUID,
        customers
      });
      return response;
  ...
  async getVehicles(orgUID: string) {
    try {
      const response = await apiService.get(`/api/Vehicle/GetVehiclesByOrg?orgUID=${orgUID}`);
      return response;
    } catch (error) {
  ...
  async getEmployees(orgUID: string) {
    try {
      const response = await apiService.get(`/api/Employee/GetEmployeesByOrg?orgUID=${orgUID}`);
      return response;
    } catch (error) {
  ...
  async getRoles(orgUID: string) {
    try {
      const response = await apiService.get(`/api/Role/GetRolesByOrg?orgUID=${orgUID}`);
      return response;
    } catch (error) {
  ...
  async getRouteChangeLog(params: {
    ...
    try {
      const response = await apiService.post('/api/Route/SelectRouteChangeLogAllDetails', {
        pageNumber: params.pageNumber || 1,
        pageSize: params.pageSize || 50,
        isCountRequired: params.isCountRequired ?? true,
        filterCriterias: params.filterCriterias || [],
