...
{
    public class NotificationGeneralEmailConsumer : BaseConsumer, IConsumer<INotificationRequest>
    {
        ...
        public NotificationGeneralEmailConsumer(INotificationGeneralDataServiceBL notificationDataServiceBL,
            INotificationEmailServiceBL notificationEmailServiceBL, IConfiguration configuration) 
            : base(configuration, Models.Enum.NotificationType.Email, ConsumerSections.General)
        {
        ...
        protected async override Task ConsumeNotification(ConsumeContext<INotificationRequest> context)
        {
            ...
            Console.WriteLine($"Processing data by NotificationGeneralEmailConsumer");
