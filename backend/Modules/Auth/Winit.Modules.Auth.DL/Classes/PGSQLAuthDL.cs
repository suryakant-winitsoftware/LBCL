...
public class PGSQLAuthDL : PostgresDBManager, IAuthDL
{
    private readonly IEmpBL _empBL;
    private readonly IRSSMailQueueBL _rSSMailQueueBL;
    public PGSQLAuthDL(IServiceProvider serviceProvider, IConfiguration config, IEmpBL empBL, IRSSMailQueueBL rSSMailQueueBL) : base(serviceProvider, config)
    {
        _empBL = empBL;
