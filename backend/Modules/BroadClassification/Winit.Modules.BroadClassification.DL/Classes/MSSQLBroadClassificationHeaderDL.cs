...
{
    public class MSSQLBroadClassificationHeaderDL : Winit.Modules.Base.DL.DBManager.SqlServerDBManager, IBroadClassificationHeaderDL
    {
        public MSSQLBroadClassificationHeaderDL(IServiceProvider serviceProvider, IConfiguration config) : base(serviceProvider, config)
        {
        }
