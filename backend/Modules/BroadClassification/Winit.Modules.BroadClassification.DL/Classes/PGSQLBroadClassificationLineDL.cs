...
{
    public class PGSQLBroadClassificationLineDL : Winit.Modules.Base.DL.DBManager.PostgresDBManager, Winit.Modules.BroadClassification.DL.Interfaces.IBroadClassificationLineDL
    {
        public PGSQLBroadClassificationLineDL(IServiceProvider serviceProvider, IConfiguration config) : base(serviceProvider, config)
        {
        }
        ...
        public async Task<int> DeleteBroadClassificationLine(String UID)
        {
                ...
                Dictionary<string, object> parameters = new Dictionary<string, object>
            {
                ...
                var sql = "DELETE  FROM broad_classification_line uid = @UID";
