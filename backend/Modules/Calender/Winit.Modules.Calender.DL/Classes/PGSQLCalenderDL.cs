...
{
    public class PGSQLCalenderDL : PostgresDBManager, ICalenderDL
    {
        public PGSQLCalenderDL(IServiceProvider serviceProvider, IConfiguration config) : base(serviceProvider, config)
        {
        }
