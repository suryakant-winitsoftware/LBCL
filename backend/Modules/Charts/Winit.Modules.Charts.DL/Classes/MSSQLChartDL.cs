...
{
    public class MSSQLChartDL : Winit.Modules.Base.DL.DBManager.SqlServerDBManager, IChartDL
    {
        public MSSQLChartDL(IServiceProvider serviceProvider, IConfiguration config) : base(serviceProvider, config)
        {
        }
