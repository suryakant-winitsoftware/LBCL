...
{
    public class RejectPaymentWebViewModel : RejectPaymentBaseViewModel
    {
        protected readonly ApiService _apiService;
        public RejectPaymentWebViewModel(IServiceProvider serviceProvider,IAppConfig appConfig,IAppUser appUser, ApiService apiService) : base(serviceProvider,appConfig,appUser)
        {
