...
{
    public interface ISettlePaymentViewModel
    {
        ...
        Task<Winit.Shared.Models.Common.ApiResponse<string>> OnClickApproveReject(string UID, string Button, string Comments1, string SessionUserCode, string ReceiptNumber, string ChequeNo1);
    }
}
