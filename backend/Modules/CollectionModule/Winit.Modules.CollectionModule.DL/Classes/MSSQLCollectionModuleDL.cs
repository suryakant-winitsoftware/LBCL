...
{
    public class MSSQLCollectionModuleDL : Base.DL.DBManager.SqlServerDBManager, Interfaces.ICollectionModuleDL
    {
        public MSSQLCollectionModuleDL(IServiceProvider serviceProvider, IConfiguration config) : base(serviceProvider, config)
        {
        ...
        //Common Methods 
        public async Task<string> InsertAccCollection(SqlConnection conn, SqlTransaction transaction, ICollections collection)
        {
            ...
            var sql = @"INSERT INTO acc_collection (
                        uid, created_by, created_time, modified_by, modified_time, server_add_time, server_modified_time, 
                        receipt_number, consolidated_receipt_number, category, amount, currency_uid, default_currency_uid, 
                        default_currency_exchange_rate, default_currency_amount, org_uid, distribution_channel_uid, store_uid, 
                        route_uid, job_position_uid, emp_uid, collected_date, status, remarks, reference_number, is_realized, 
                        latitude, longitude, source, is_multimode, trip_date, comments, salesman, route, reversal_receipt_uid, 
                        cancelled_on, ss)
                    VALUES (
                        @UID, @CreatedBy, @CreatedTime, @ModifiedBy, @ModifiedTime, @ServerAddTime, @ServerModifiedTime, 
                        @ReceiptNumber, @ConsolidatedReceiptNumber, @Category, @Amount, @CurrencyUID, @DefaultCurrencyUID, 
                        @DefaultCurrencyExchangeRate, @DefaultCurrencyAmount, @OrgUID, @DistributionChannelUID, @StoreUID, 
                        @RouteUID, @JobPositionUID, @EmpUID, @CollectedDate, @Status, @Remarks, @ReferenceNumber, @IsRealized, 
                        @Latitude, @Longitude, @Source, @IsMultimode, @TripDate, @Comments, @Salesman, @Route, @ReversalReceiptUID, 
                        @CancelledOn, @SS);";
            ...
            Retval = Convert.ToString(await ExecuteNonQueryAsync(sql, conn, transaction, parameters));
            if (Retval != Const.One)
            {
                return Retval;
            }
        ...
        public async Task<String> InsertAccCollectionPaymentMode(SqlConnection conn, SqlTransaction transaction, ICollections collection)
        {
            var Retval = string.Empty;
            var sql1 = @"INSERT INTO dbo.acc_collection_payment_mode (
                        uid, created_by, created_time, modified_by, modified_time, server_add_time, 
                        server_modified_time, acc_collection_uid, bank_uid, branch, cheque_no, amount, 
                        currency_uid, default_currency_uid, default_currency_exchange_rate, default_currency_amount, 
                        cheque_date, status, realization_date, ss)
                        VALUES (@UID, @CreatedBy, @CreatedTime, @ModifiedBy, @ModifiedTime, @ServerAddTime, @ServerModifiedTime, 
                        @AccCollectionUID, @BankUID, @Branch, @ChequeNo, @Amount, @CurrencyUID, @DefaultCurrencyUID, 
                        @DefaultCurrencyExchangeRate, @DefaultCurrencyAmount, @ChequeDate, @Status, @RealizationDate, @SS);";
            ...
            Retval = Convert.ToString(await ExecuteNonQueryAsync(sql1, conn, transaction, parameters1));
            if (Retval != Const.One)
                return Retval;
            else
                return Retval;
        }
        public async Task<string> InsertAccStoreLedger(SqlConnection conn, SqlTransaction transaction, ICollections collection)
        {
            ...
            var Retval = string.Empty;
            var sql3 = @"INSERT INTO dbo.acc_store_ledger (
                        uid, created_by, created_time, modified_by, modified_time, server_add_time, 
                        server_modified_time, source_type, source_uid, credit_type, org_uid, store_uid, default_currency_uid, 
                        document_number, default_currency_exchange_rate, default_currency_amount, amount, transaction_date_time, 
                        collected_amount, currency_uid, balance, comments, ss)
                        VALUES (@UID, @CreatedBy, @CreatedTime, @ModifiedBy, @ModifiedTime, @ServerAddTime, @ServerModifiedTime, 
                        @SourceType, @SourceUID, @CreditType, @OrgUID, @StoreUID, @DefaultCurrencyUID, @DocumentNumber, 
                        @DefaultCurrencyExchangeRate, @DefaultCurrencyAmount, @Amount, @TransactionDateTime, @CollectedAmount, 
                        @CurrencyUID, @Balance, @Comments, @SS);";
            ...
            Retval = Convert.ToString(await ExecuteNonQueryAsync(sql3, conn, transaction, parameters3));
            if (Retval != Const.One)
                return Retval;
            else
                return Retval;
        }
        public async Task<string> InsertAccCollectionAllotment(SqlConnection conn, SqlTransaction transaction, ICollections collection)
        {
            var Retval = string.Empty;
            ...
            foreach (var list in collection.AccCollectionAllotment)
            {
                try
                {
                    ...
                    var sql2 = @"INSERT INTO dbo.acc_collection_allotment (
                                uid, created_by, created_time, modified_by, modified_time, server_add_time, 
                                server_modified_time, acc_collection_uid, target_type, target_uid, reference_number, currency_uid,
                                default_currency_uid, default_currency_exchange_rate, default_currency_amount, early_payment_discount_percentage, 
                                early_payment_discount_amount, amount, early_payment_discount_reference_no, ss)
                                VALUES (
                                @UID, @CreatedBy, @CreatedTime, @ModifiedBy, @ModifiedTime, @ServerAddTime, @ServerModifiedTime, @AccCollectionUID,
                                @TargetType, @TargetUID, @ReferenceNumber, @CurrencyUID, @DefaultCurrencyUID, @DefaultCurrencyExchangeRate, @DefaultCurrencyAmount, 
                                @EarlyPaymentDiscountPercentage, @EarlyPaymentDiscountAmount, @Amount, @EarlyPaymentDiscountReferenceNo, @SS);";
                    Dictionary<string, object> parameters2 = new Dictionary<string, object>
                {
                    ...
                    Retval = Convert.ToString(await ExecuteNonQueryAsync(sql2, conn, transaction, parameters2));
        ...
        public async Task<string> InsertAccCollectionCurrencyDetails(SqlConnection conn, SqlTransaction transaction, ICollections collection)
        {
            try
            {
                var Result = "";
                if (collection.AccCollectionCurrencyDetails != null)
                {
                    ...
                    {
                        var sql = @"INSERT INTO dbo.acc_collection_currency_details (
                                    uid, created_by, created_time, modified_by, modified_time, server_add_time, 
                                    server_modified_time, acc_collection_uid, currency_uid, default_currency_uid, 
                                    default_currency_exchange_rate, amount, default_currency_amount, 
                                    final_default_currency_amount, ss)
                                    VALUES (
                        ...
                        Result = Convert.ToString(await ExecuteNonQueryAsync(sql, conn, transaction, parameters));
        ...
        public async Task<string> DeleteCreditNote(string AccCollectionUID, SqlConnection conn, SqlTransaction transaction)
        {
            try
            {
                var Retval = string.Empty;
                var sql2 = @"DELETE FROM dbo.acc_receivable
                                    WHERE reference_number IN (
                                    SELECT al.reference_number
                                    FROM dbo.acc_receivable ar
                                    INNER JOIN dbo.acc_collection_allotment al 
        ...
        public async Task<string> UpdateAccReceivable(SqlConnection conn, SqlTransaction transaction, ICollections collection)
        {
            var Retval = string.Empty;
            foreach (var list in collection.AccCollectionAllotment.Where(p => p.TargetType.Contains("CREDITNOTE") && !collection.AccCollection.IsEarlyPayment))
            {
                ...
                var sql5 = @"UPDATE dbo.acc_receivable
                            SET 
                ...
                Retval = Convert.ToString(await ExecuteNonQueryAsync(sql5, conn, transaction, parameters5));
                if (Retval != Const.One)
                    return Retval;
            }
            return Retval;
        ...
        public async Task<string> UpdateAccPayable(SqlConnection conn, SqlTransaction transaction, ICollections collection)
        {
            var Retval = string.Empty;
            foreach (var list in collection.AccCollectionAllotment.Where(p => p.TargetType.Contains("INVOICE")))
            {
                ...
                var sql4 = @"UPDATE dbo.acc_payable
                            SET 
                            modified_time = @ModifiedTime, 
                            modified_by = @ModifiedBy,
                            server_modified_time = @ServerModifiedTime, 
                ...
                var sql1 = @"UPDATE dbo.acc_payable
                            SET 
                            modified_time = @ModifiedTime, 
                            modified_by = @ModifiedBy,
                            server_modified_time = @ServerModifiedTime, 
                            unsettled_amount = unsettled_amount + @UnSettledAmount
                            WHERE store_uid = @StoreUID AND reference_number = @ReferenceNumber;";
                Dictionary<string, object> parameters4 = new Dictionary<string, object>
                            {
                                {"PaidAmount", list.PaidAmount==0 ? 0 :(collection.AccCollection.IsEarlyPayment ? (list.PaidAmount + list.DiscountAmount) : list.PaidAmount)},
                                {"ModifiedTime", DateTime.Now},
                                {"ModifiedBy", string.IsNullOrEmpty(collection.AccCollection.ModifiedBy) ?string.Empty: collection.AccCollection.ModifiedBy},
                                {"ServerModifiedTime", DateTime.Now},
                ...
                Retval = collection.AccCollection.Category == Const.Cash ? Convert.ToString(await ExecuteNonQueryAsync(sql4, conn, transaction, parameters4)) : Convert.ToString(await ExecuteNonQueryAsync(sql1, conn, transaction, parameters1));
                if (Retval != Const.One)
                    return Retval;
            }
            return Retval;
        }
        public async Task<string> InsertAccPayable(SqlConnection conn, SqlTransaction transaction, ICollections collection)
        {
            var Retval = string.Empty;

            foreach (var list in collection.AccPayable)
            {
                if (await CheckIfUIDExistsInDB("acc_payable", list.UID) != null)
                {
                    try
                    {
                        var sql1 = @"INSERT INTO dbo.acc_payable (
                        uid, created_by, created_time, modified_by, modified_time, server_add_time,
        ...
        public async Task<string> InsertAccReceivable(SqlConnection conn, SqlTransaction transaction, ICollections collection)
        {
            var Retval = string.Empty;
            foreach (var list in collection.AccCollectionAllotment)
            {
                ...
                {
                    var sql1 = @"INSERT INTO dbo.acc_receivable (
                                uid, created_by, created_time, modified_by, modified_time, server_add_time,
                                server_modified_time, source_type, source_uid, reference_number, org_uid,
                                job_position_uid, amount, paid_amount, store_uid, transaction_date,
        ...
        public async Task<string> InsertEarlyPaymentDiscountAppliedDetails(SqlConnection conn, SqlTransaction transaction, ICollections collection)
        {
            var Retval = string.Empty;
            foreach (var list in collection.AccCollectionAllotment)
            {
        ...
        public async Task<string> CheckExists(string Receiptnumber)
        {
            try
            {
                ...
                var sql = @"SELECT 
                            ...
                            collection_amount AS CollectionAmount, received_amount AS ReceivedAmount, 
                            has_discrepancy AS HasDiscrepancy, discrepancy_amount AS DiscrepancyAmount, 
                            default_currency_uid AS DefaultCurrencyUID, settlement_date AS SettlementDate, 
                            cashier_job_position_uid AS CashierJobPositionUID, cashier_emp_uid AS CashierEmpUID, 
                            receipt_number AS ReceiptNumber, settled_by AS SettledBy, session_user_code AS SessionUserCode, 
                            route AS Route, user_code AS UserCode, target_type AS TargetType, payment_mode AS PaymentMode, 
                            transaction_date AS TransactionDate, due_date AS DueDate, is_void AS IsVoid, cash_number AS CashNumber
                        FROM 
                            dbo.acc_collection_settlement 
        ...
        public async Task<Model.Interfaces.ICollections> GetAmount(string ReceiptNumber)
        {
            ...
            try
            {
                ...
                var sql = @"SELECT 
                            ...
                            route AS Route, reversal_receipt_uid AS ReversalReceiptUID, cancelled_on AS CancelledOn
                        FROM  
                            dbo.acc_collection 
                        WHERE 
        ...
        public async Task<Model.Interfaces.IAccCollection> GetCollectAmount(string ReceiptNumber)
        {
            ...
            try
            {
                ...
                var sql = @"SELECT MIN(amount) AS MinAmount 
                        FROM 
                            acc_collection 
                        WHERE 
                            receipt_number = @ReceiptNumber;";
        ...
        public async Task<Model.Interfaces.IAccCollectionPaymentMode> GetPaymentAmount(string ReceiptNumber, SqlConnection conn, SqlTransaction transaction)
        {
            Dictionary<string, object> parameters = new Dictionary<string, object>
                {
                    {"AccCollectionUID",  ReceiptNumber}
            ...
            var sql = @"SELECT 
                    ...
                    FROM 
                        dbo.acc_collection_payment_mode 
                    WHERE 
        ...
        public async Task<IEnumerable<Model.Interfaces.IAccCollectionAllotment>> AllInvoices(string AccCollectionUID)
        {
            ...
            var sql = @"SELECT id AS Id, uid AS UID, created_by AS CreatedBy, created_time AS CreatedTime, 
                    ...
                    FROM 
                        acc_collection_allotment 
                    WHERE 
                        (acc_collection_uid = @AccCollectionUID AND amount <> 0)
                        OR 
                        (target_uid LIKE '%CN%' AND amount <> 0)
                    ORDER BY 
                        created_time DESC;";
        ...
        public async Task<IEnumerable<Model.Interfaces.IAccCollection>> SettledDetails(string Status)
        {
            ...
            var sql = @"SELECT id AS Id, uid AS UID, created_by AS CreatedBy, created_time AS CreatedTime, 
                        ...
                        acc_collection where status = @Status";
            Type type = _serviceProvider.GetRequiredService<Model.Interfaces.IAccCollection>().GetType();
        ...
        public async Task<IEnumerable<Model.Interfaces.IAccCollectionAllotment>> ReceivUnsettle(string UID, string ChequeNo)
        {
            ...
            var sql = @"SELECT 
                ...
                FROM 
                    acc_collection_allotment AL
                INNER JOIN 
                    acc_collection AC ON AC.uid = AL.acc_collection_uid
                WHERE 
        ...
        public async Task<IEnumerable<Model.Interfaces.IAccPayable>> PayableUnsettle(string AccCollectionUID)
        {
            ...
            FROM 
                acc_collection_allotment AL
            INNER JOIN 
                acc_payable AP ON AL.target_uid = AP.uid
            WHERE 
                AL.acc_collection_uid = @AccCollectionUID;";
        ...
        public async Task<IEnumerable<Model.Interfaces.IAccCollectionAllotment>> GetCashAllot(string AccCollectionUID, SqlConnection conn, SqlTransaction transaction)
        {
            Dictionary<string, object> parameters = new Dictionary<string, object>
            {
                 {"AccCollectionUID",  AccCollectionUID}
        ...
        public async Task<IEnumerable<Model.Interfaces.IAccPayable>> GetChequePay(string AccCollectionUID, SqlConnection conn, SqlTransaction transaction)
        {
            Dictionary<string, object> parameters = new Dictionary<string, object>
            {
                 {"AccCollectionUID",  AccCollectionUID}
        ...
        public async Task<IEnumerable<Model.Interfaces.IAccReceivable>> GetChequeRec(string DocumentType, SqlConnection conn, SqlTransaction transaction)
        {
            Dictionary<string, object> parameters = new Dictionary<string, object>
            {
            ...
            acc_receivable where uid = @DocumentType";
        ...
        public async Task<Model.Interfaces.IAccStoreLedger> GetStoreLedger(string ReceiptNumber, SqlConnection conn, SqlTransaction transaction)
        {
            Dictionary<string, object> parameters = new Dictionary<string, object>
                {
            ...
            amount AS Amount, balance AS Balance, comments AS Comments FROM acc_store_ledger 
        ...
        public async Task<Model.Interfaces.IAccStoreLedger> GetStoreLedgerCreation(string StoreUID, SqlConnection conn, SqlTransaction transaction)
        {
            Dictionary<string, object> parameters = new Dictionary<string, object>
         {
             {"StoreUID",  StoreUID}
            ...
            store_uid AS StoreUID, default_currency_uid AS DefaultCurrencyUID, document_number AS DocumentNumber, default_currency_exchange_rate AS DefaultCurrencyExchangeRate, 
            default_currency_amount AS DefaultCurrencyAmount, transaction_date_time AS TransactionDateTime, collected_amount AS CollectedAmount, currency_uid AS CurrencyUID,
            amount AS Amount, balance AS Balance, comments AS Comments FROM acc_store_ledger  where store_uid = @StoreUID Order By created_time Desc";
        ...
        public async Task<Model.Interfaces.IAccReceivable> GetAccReceivableAmount(string ReferenceNumber)
        {
            ...
            Model.Interfaces.IAccReceivable CollectionModuleList = await ExecuteSingleAsync<Model.Interfaces.IAccReceivable>(sql, parameters);
            return CollectionModuleList;
        }
        ...
        public async Task<Model.Interfaces.IAccPayable> GetAccPayableAmount(string StoreUID, string ReferenceNumber)
        {
            try
            {
                ...
                source AS Source, currency_uid AS CurrencyUID
                FROM 
                    acc_payable Where store_uid = @StoreUID and reference_number = @ReferenceNumber";

                Model.Interfaces.IAccPayable CollectionModuleList = (await ExecuteQueryAsync<Model.Interfaces.IAccPayable>(sql, parameters)).FirstOrDefault();
                return CollectionModuleList;
            }
            catch (Exception ex)
            {
        ...
        public async Task<IEnumerable<Model.Interfaces.IAccPayable>> GetInvoicesAutoAllocateByUID(int Start, int End, string StoreUID)
        {
                ...
                FROM 
                    acc_payable
                                WHERE store_uid = @StoreUID
                                  AND DATEDIFF(day, transaction_date, GETDATE()) BETWEEN @startDay AND @endDay Order By transaction_date";
            ...
            var sql1 = @"SELECT id AS Id, uid AS UID, created_by AS CreatedBy, created_time AS CreatedTime, modified_by AS ModifiedBy, modified_time AS ModifiedTime, server_add_time AS ServerAddTime,
                ...
                FROM 
                    acc_payable
                                WHERE store_uid = @StoreUID
                                  AND DATEDIFF(day, transaction_date, GETDATE()) >= @startDay Order By transaction_date";
        ...
        public async Task<Model.Interfaces.IAccReceivable> GetAccRecAmount(string StoreUID, string ReferenceNumber)
        {
            ...
            currency_uid AS CurrencyUID, amount AS Amount, paid_amount AS PaidAmount, store_uid AS StoreUID, transaction_date AS TransactionDate, due_date AS DueDate, unsettled_amount AS UnSettledAmount,
            balance_amount AS BalanceAmount, source AS Source FROM 
            acc_receivable Where store_uid = @StoreUID and reference_number = @ReferenceNumber";
        ...
        public async Task<IEnumerable<Model.Interfaces.IAccCollection>> GetAllConfiguredPaymentModesBySalesOrgCode(string SessionUserCode, string SalesOrgCode = null)
        {
            ...
            var sql = @"SELECT id AS Id, uid AS UID, created_by AS CreatedBy, created_time AS CreatedTime, modified_by AS ModifiedBy, modified_time AS ModifiedTime, server_add_time AS ServerAddTime,
                ...
                source AS Source, currency_uid AS CurrencyUID
                FROM 
                    acc_payable Where store_uid = @StoreUID";
        ...
        public async Task<IEnumerable<IStore>> GetAllCustomersBySalesOrgCode(string SessionUserCode, string SalesOrgCode = null)
        {
                ...
                Dictionary<string, object> parameters = new Dictionary<string, object>
            {
                ...
                var sql = @"SELECT code AS Code,
					...
					FROM store 
					where --franchisee_org_uid = @StoreUID AND 
                    type = 'FR' AND is_active = 'true'";
        ...
        public async Task<IEnumerable<Model.Interfaces.ICollectionModule>> GetAllOutstandingTransactionsByMultipleFilters(string SessionUserCode, string SalesOrgCode = null, string CustomerCode = null, string StartDueDate = null, string EndDueDate = null, string StartInvoiceDate = null, string EndInvoiceDate = null)
        {
            ...
            var sql = @"SELECT id AS Id, uid AS UID, created_by AS CreatedBy, created_time AS CreatedTime, 
                        ...
                        trip_date AS TripDate, comments AS Comments, salesman AS Salesman, 
                        route AS Route, reversal_receipt_uid AS ReversalReceiptUID, cancelled_on AS CancelledOn FROM 
                        acc_collection Where store_uid = @StoreUID";
                        ...
                        foreach (var list in accCollectionPayable)
                        {
                            ...
                            if (list.BalanceAmount != 0)
                            {
                                ...
                                if (enteredAmount > arrayAmount)
                                {
                                    ...
                                    var accAllot = Convert.ToString(await ExecuteNonQueryAsync(sql2, conn, transaction, parameters2));
                                    ...
                                    var accPay = collection.AccCollection.Category == Const.Cash ? Convert.ToString(await ExecuteNonQueryAsync(sql4, conn, transaction, parameters4)) : Convert.ToString(await ExecuteNonQueryAsync(sql1, conn, transaction, parameters1));
                                ...
                                else
                                {
                                    ...
                                    var allot = Convert.ToString(await ExecuteNonQueryAsync(sql2, conn, transaction, parameters2));
                        ...
                        if (collection != null)
                        {
                            if (collection.AccCollection.UID != null)
                            {
                                ...
                                if (collection.AccCollection.Category == "Cash" || collection.AccCollection.Category == "OnAccount")
                                {
                                    ...
                                    Retval4 = Convert.ToString(await ExecuteNonQueryAsync(sql4, conn, transaction, parameters4));
                                }
                ...
                using (var transaction = conn.BeginTransaction())
                {
                    if (collection != null)
                    {
                            ...
                            Dictionary<string, object> parameters1 = new Dictionary<string, object>
                        {
                            ...
                            Retval1 = Convert.ToString(await ExecuteNonQueryAsync(sql1, conn, transaction, parameters1));
                                ...
                                Dictionary<string, object> parameters2 = new Dictionary<string, object>
                            {
                                ...
                                if (accCollectionAllotment.TargetType.Contains("INVOICE"))
                                {
                                    ...
                                    foreach (var list1 in payb)
                                    {
                                        ...
                                        Retval = Convert.ToString(await ExecuteNonQueryAsync(sql4, conn, transaction, parameters4));
                                        if (Retval != Const.One)
                                        {
                                            return Retval;
                                        }
                ...
                using (var transaction = conn.BeginTransaction())
                {
                    ...
                    if (ReceiptNumber != null && ReceiptNumber != string.Empty)
                    {
                        ...
                        if (Exist)
                        {
                            ...
                            var Retval = string.Empty;
                            var sql = @"INSERT INTO acc_collection(uid, created_by, created_time, modified_by, modified_time, server_add_time, server_modified_time, receipt_number, consolidated_receipt_number, 
        ...
        public async Task<string> UpdateUnSettledAmount(string UID, string ChequeNo, SqlConnection conn, SqlTransaction transaction)
        {
            try
            {
                var Retval = string.Empty;
                ...
                if (UID != null && UID != string.Empty)
                {
                    ...
                    foreach (var list in recv)
                    {
                        ...
                        {
                            var sql1 = @"INSERT INTO acc_receivable(
	                             uid, created_by, created_time, modified_by, modified_time, server_add_time,
	                             server_modified_time, source_type, source_uid, reference_number, org_uid,
	                             job_position_uid, amount, paid_amount, store_uid, transaction_date,
            ...
            try
            {
                using (var conn = new SqlConnection(_connectionString))
                {
                            ...
                            Dictionary<string, object> parameters1 = new Dictionary<string, object>
                    {
                            ...
                            Retval = Button == "Approved" ? Convert.ToString(await ExecuteNonQueryAsync(sql, conn, transaction, parameters)) : Convert.ToString(await ExecuteNonQueryAsync(sql, conn, transaction, parameters1));
                            if (Retval != Const.One)
                            {
                                return Retval;
                            }
                            if (Button == "Approved")
                            {
                                ...
                                Dictionary<string, object> parameters4 = new Dictionary<string, object>
                             {
                                ...
                                Retval = accCollectionPayment.ReceiptNumber.Contains("OA") ? Convert.ToString(await ExecuteNonQueryAsync(sql4, conn, transaction, parameters4)) : Convert.ToString(await ExecuteNonQueryAsync(sql3, conn, transaction, parameters3));
                                if (Retval != Const.One)
                                {
                                    return Retval;
                                }
        ...
        public async Task<int> UpdateChequeDetails(IAccCollectionPaymentMode collection)
        {
            using (var conn = new SqlConnection(_connectionString))
            {
                ...
                {
                    int Retval = 0;
                    var sql = @"INSERT INTO acc_collection_payment_mode(
                    ...
                    Dictionary<string, object> parameters = new Dictionary<string, object>
            {
                ...
                {"UID", (Guid.NewGuid()).ToString() }
                    ...
                    Retval = Convert.ToInt32(await ExecuteNonQueryAsync(sql, conn, transaction, parameters));
                    if (Retval != 1)
                    {
                        return Retval;
                    }
        ...
        public async Task<IEnumerable<Model.Interfaces.IAccUser>> GetUser()
        {
            ...
            var sql = @"SELECT user_name, user_code, password FROM acc_user;";
        ...
        public async Task<IEnumerable<Model.Interfaces.IAccCollectionPaymentMode>> GetChequeDetails(string UID, string TargetUID)
        {
            ...
            var sql = @"SELECT 
                        ...
                        acc_collection_payment_mode where acc_collection_uid =@UID ";
        ...
        public async Task<IEnumerable<Model.Interfaces.IAccCollection>> IsReversal2(string UID, string ReverseNo, string Reason, SqlConnection conn, SqlTransaction transaction, string Status = null)
        {
            Dictionary<string, object> parameters = new Dictionary<string, object>
            {
                {"UID", UID }
        ...
        public async Task<string> UpdateCollection(string UID, string ReverseNo, string Reason, SqlConnection conn, SqlTransaction transaction, string Status = null)
        {
            var Retval = string.Empty;
            if (UID != null && UID != string.Empty)
            {
        ...
        public async Task<string> UpdateCashCollection(string CashNumber, string SessionUserCode, SqlConnection conn, SqlTransaction transaction)
        {
            var Retval = string.Empty;
        ...
        public async Task<string> UpdateChequeCollection(string UID, string Button, SqlConnection conn, SqlTransaction transaction)
        {
            var Retval = string.Empty;
            if (UID != null && UID != string.Empty)
            {
        ...
        public async Task<string> UpdatePayableUnsettle(string AccCollectionUID, string Button, SqlConnection conn, SqlTransaction transaction)
        {
            var Retval = string.Empty;
        ...
        public async Task<IEnumerable<IAccPayable>> DaysTable(string StoreUID)
        {
                ...
                Dictionary<string, object> parameters = new Dictionary<string, object>
            {
                ...
                var sql = @"WITH delay_time_categories AS (
                        ...
                        FROM 
                            delay_time_categories dt
                        LEFT JOIN 
                            acc_payable ap ON dt.DelayTime =
                                CASE 
                                    WHEN DATEDIFF(day, ap.transaction_date, GETDATE()) BETWEEN 0 AND 30 THEN '0-30 days'
                                    WHEN DATEDIFF(day, ap.transaction_date, GETDATE()) BETWEEN 31 AND 60 THEN '30-60 days'
                                    WHEN DATEDIFF(day, ap.transaction_date, GETDATE()) BETWEEN 61 AND 90 THEN '60-90 days'
                                    WHEN DATEDIFF(day, ap.transaction_date, GETDATE()) > 90 THEN '90+ days'
                                    ELSE 'Unknown'
                                END
                        WHERE 
                            ap.store_uid = @StoreUID OR ap.store_uid IS NULL
                        GROUP BY 
                            dt.DelayTime, ap.store_uid;";
                Type type = _serviceProvider.GetRequiredService<Model.Interfaces.IAccPayable>().GetType();
                IEnumerable<Model.Interfaces.IAccPayable> CollectionModuleList = await ExecuteQueryAsync<Model.Interfaces.IAccPayable>(sql, parameters, type);
                return CollectionModuleList;
            }
        ...
        public async Task<IEnumerable<IAccPayable>> DaysTableParent(string StoreUID, int startDay, int endDay)
        {
            try
            {
                ...
                FROM acc_payable
                WHERE store_uid = @StoreUID
                AND DATEDIFF(day, transaction_date, GETDATE()) BETWEEN @startDay AND @endDay;";
                ...
                FROM acc_payable
                WHERE store_uid = @StoreUID
                AND DATEDIFF(day, transaction_date, GETDATE()) >= @startDay;";
        ...
        public async Task<IEnumerable<IAccPayable>> GetCreditNotes(string AccCollectionUID)
        {
            ...
            currency_uid AS CurrencyUID, amount AS Amount, paid_amount AS PaidAmount, store_uid AS StoreUID, transaction_date AS TransactionDate, due_date AS DueDate, unsettled_amount AS UnSettledAmount,
            balance_amount AS BalanceAmount, source AS Source FROM 
            acc_receivable where store_uid = @StoreUID";
            Type type = _serviceProvider.GetRequiredService<Model.Interfaces.IAccPayable>().GetType();
        ...
        public async Task<IEnumerable<Winit.Modules.Setting.Model.Interfaces.ISetting>> GetSettingByType(string UID)
        {
            ...
            var sql = @"SELECT id, uid, type, name, value, data_type, is_editable, ss, created_time, modified_time, server_add_time, server_modified_time FROM setting where value = 'True'";
        ...
        public async Task<List<Winit.Modules.CollectionModule.Model.Interfaces.IAccStoreLedger>> GetAccountStatement(string StoreUID, string FromDate, string ToDate)
        {
            try
            {
                ...
                var sql = @"WITH StoreInfo AS (
                        ...
                        FROM 
                            acc_store_ledger SL 
                        INNER JOIN acc_collection AC ON SL.document_number = AC.receipt_number 
                        INNER JOIN store AST ON AST.uid = AC.store_uid WHERE 
            ...
            try
            {
                using (var conn = new SqlConnection(_connectionString))
                {
                    ...
                    using (var transaction = conn.BeginTransaction())
                    {
                        ...
                        var Retval = string.Empty;
                        var updatesql = @"UPDATE early_payment_discount_configuration
                        ...
                        var insertsql = @"INSERT INTO early_payment_discount_configuration(uid, created_by, created_time, modified_by, modified_time, 
                        ...
                        Retval = IsSameCustomer ? Convert.ToString(await ExecuteNonQueryAsync(updatesql, conn, transaction, updateparameters)) : Convert.ToString(await ExecuteNonQueryAsync(insertsql, conn, transaction, insertparameters));
                        if (Retval != Const.One)
                        {
                            return Retval;
                        }
    ...
    .ToList();
            ...
            try
            {
                ...
                using (var conn = new SqlConnection(_connectionString))
                {
                    ...
                    using (var transaction = conn.BeginTransaction())
                    {
                        ...
                        SET modified_time = @ModifiedTime, modified_by = @ModifiedBy,
                        server_modified_time = @ServerModifiedTime,
                        collection_deposit_status = @Status WHERE receipt_number IN (@UIDs);";
            ...
            Dictionary<string, object?> parameters = new()
        {
            ...
            return await ExecuteSingleAsync<List<string>>(sql, parameters, null, connection, transaction);
        }
            ...
            int pageSize, List<FilterCriteria> filterCriterias, string PageName)
        {
            try
            {
                ...
                var ViewPaymentsql = new StringBuilder(@"select * from(SELECT id AS Id, uid AS UID, created_by AS CreatedBy, created_time AS CreatedTime, 
                        ...
                        trip_date AS TripDate, comments AS Comments, salesman AS Salesman, 
                        route AS Route, reversal_receipt_uid AS ReversalReceiptUID, cancelled_on AS CancelledOn FROM 
                        acc_collection) as SubQuery where ReceiptNumber not like 'R -%'");
            ...
            int pageSize, List<FilterCriteria> filterCriterias, bool isCountRequired, string StartDate, string EndDate)
        {
            try
            {
                var sql = new StringBuilder(@"select * from(SELECT id AS Id, uid AS UID, created_by AS CreatedBy, created_time AS CreatedTime, 
                                            ...
                                            transaction_type AS TransactionType, source_type AS OrderType, 
                                            source_uid AS SourceUID, document_number AS ReferenceNumber, 
                ...
                {
                    StringBuilder sbFilterCriteria = new StringBuilder();
                    sbFilterCriteria.Append(" where TransactionDateTime >= @StartDate And TransactionDateTime <= @EndDate And ");
                    AppendFilterCriteria<IAccCollection>
                        (filterCriterias, sbFilterCriteria, parameters);
                    sql.Append(sbFilterCriteria);
                    if (isCountRequired)
                ...
                {
                    StringBuilder sbFilterCriteria = new StringBuilder();
                    sbFilterCriteria.Append(" where TransactionDateTime >= @StartDate And TransactionDateTime <= @EndDate ");
                    sql.Append(sbFilterCriteria);
                }
                if (sortCriterias != null && sortCriterias.Count > 0)
                {
                ...
                List<Model.Interfaces.IStoreStatement> CollectionModuleList = await ExecuteQueryAsync<Model.Interfaces.IStoreStatement>(sql.ToString(), parameters);
                int totalCount = Const.Num;
                if (isCountRequired)
                {
                    // Get the total count of records
        ...
        public async Task<bool> UpdateBalanceConfirmation(IBalanceConfirmation balanceConfirmation)
        {
            try
            {
                ...
                using (var conn = new SqlConnection(_connectionString))
                {
                    ...
                    using (var transaction = conn.BeginTransaction())
                    {
                        var sql = @"Update balance_confirmation Set start_date = @StartDate, end_date = @EndDate, status = @Status, otp = @Otp, confirm_request_time = @ConfirmRequestTime , confirm_competion_time = @ConfirmCompetionTime,
                                    request_by_job_position_uid = @RequestByJobPositionUID , request_by_emp_uid = @RequestByEmpUID
                                    Where uid = @UID";
                        Dictionary<string, object> parameters = new Dictionary<string, object>
                            {
                                {"UID", balanceConfirmation.UID },
                                {"StartDate", balanceConfirmation.StartDate },
                                {"EndDate", balanceConfirmation.EndDate  },
        ...
        public async Task<bool> UpdateBalanceConfirmationForResolvingDispute(IBalanceConfirmation balanceConfirmationLine)
        {
            try
            {
                ...
                using (var conn = new SqlConnection(_connectionString))
                {
                    ...
                    using (var transaction = conn.BeginTransaction())
                    {
                        var sql = @"Update balance_confirmation Set status = @Status, comments = @Comments , dispute_confirmation_by_emp_uid = @EmpUID, dispute_confirmation_by_job_position_uid = @JobPositionUID
                                    Where uid = @UID";
                        Dictionary<string, object> parameters = new Dictionary<string, object>
                            {
                                {"UID", balanceConfirmationLine.UID },
                                {"Status", "Balance Approval Completed" },
                                {"Comments", balanceConfirmationLine.Comments ?? "" },
                                {"EmpUID", balanceConfirmationLine.DisputeconfirmationByEmpUID ?? "" },
                                {"JobPositionUID", balanceConfirmationLine.DisputeConfirmationByJobPositionUID ?? "" },
                            };
                        Retval = await ExecuteNonQueryAsync(sql, conn, transaction, parameters);
                        if (Retval == 0)
                        {
        ...
        public async Task<bool> UpdateBalanceConfirmationForDispute(List<IBalanceConfirmationLine> balanceConfirmation)
        {
            try
            {
                int Retval = 0;
                using (var conn = new SqlConnection(_connectionString))
                {
                    ...
                    using (var transaction = conn.BeginTransaction())
                    {
                        var sql = @"Update balance_confirmation Set  dispute_amount = @DisputeAmount,confirm_competion_time = @ConfirmCompetionTime Where uid = @UID";
                        Dictionary<string, object> parameters = new Dictionary<string, object>
                            {
                                {"UID", balanceConfirmation.First().BalanceConfirmationUID },
                                {"DisputeAmount", balanceConfirmation.Sum(p => p.ReceivedAmount) },
                                {"ConfirmCompetionTime", DateTime.Now }
                            };
                        Retval = await ExecuteNonQueryAsync(sql, conn, transaction, parameters);
                        if (Retval == 0)
                        {
            ...
            try
            {
                ...
                using (var conn = new SqlConnection(_connectionString))
                {
                    ...
                    using (var transaction = conn.BeginTransaction())
                    {
                        foreach (var data in balanceConfirmationLine)
                        {
                            var sql = @"INSERT INTO dbo.balance_confirmation_line 
                                   (uid, created_by, created_time, modified_by, modified_time, server_add_time, 
                                    ...
                                    eligible_amount, received_amount, description, diff_amount) 
                                    VALUES (@UID, @CreatedBy, @CreatedTime, @ModifiedBy, @ModifiedTime, @ServerAddTime, 
                                    @ServerModifiedTime, @Ss, @BalanceConfirmationUID, @LineNumber, @SchemeName, 
                                    @EligibleAmount, @ReceivedAmount, @Description, @DiffAmount);";
                            Dictionary<string, object> parameters = new Dictionary<string, object>
                        {
                            {"UID", data.UID },
                            ...
                            {"DiffAmount",data.EligibleAmount - data.ReceivedAmount },
                        };
                        ...
                        if (await UpdateBalanceConfirmationForDispute(balanceConfirmationLine))
                        {
                            transaction.Commit();
                            return true;
                        }
        ...
        public async Task<List<IBalanceConfirmation>> GetBalanceConfirmationListDetails()
        {
            try
            {
                ...
                var sql = @"SELECT id AS Id, uid AS UID, created_by AS CreatedBy, created_time AS CreatedTime, 
                           modified_by AS ModifiedBy, modified_time AS ModifiedTime, server_add_time AS ServerAddTime, 
                           server_modified_time AS ServerModifiedTime, ss AS Ss, org_uid AS OrgUid, store_uid AS StoreUid,store_uid AS Store, 
                           generated_time AS GeneratedOn, start_date AS StartDate, end_date AS EndDate, 
                           opening_balance AS OpeningBalance, debit_amount AS DebitAmount, credit_amount AS CreditAmount, 
                           closing_balance AS ClosingBalance, dispute_amount AS TotalDisputeAmount, status AS Status, 
                          ...
                          FROM dbo.balance_confirmation";
                List<Model.Interfaces.IBalanceConfirmation> CollectionModuleList = await ExecuteQueryAsync<Model.Interfaces.IBalanceConfirmation>(sql, parameters);
                return CollectionModuleList;
            }
            catch (Exception ex)
            {
                return new List<IBalanceConfirmation>();
            }
        }
        public async Task<IBalanceConfirmation> GetBalanceConfirmationDetails(string StoreUID)
        {
            try
            {
                ...
                var sql = @"SELECT top 1 id AS Id, uid AS UID, created_by AS CreatedBy, created_time AS CreatedTime, 
                           ...
                           dispute_confirmation_by_job_position_uid AS DisputeConfirmationByJobPositionUid, 
                           dispute_confirmation_by_emp_uid AS DisputeConfirmationByEmpUid
                          FROM dbo.balance_confirmation where store_uid = @StoreUID ";
                Model.Interfaces.IBalanceConfirmation CollectionModuleList = await ExecuteSingleAsync<Model.Interfaces.IBalanceConfirmation>(sql, parameters);
                return CollectionModuleList ?? new BalanceConfirmation();
            }
            catch (Exception ex)
            {
        ...
        public async Task<List<IBalanceConfirmationLine>> GetBalanceConfirmationLineDetails(string UID)
        {
            try
            {
                ...
                FROM dbo.balance_confirmation_line where balance_confirmation_uid = @UID";
                List<IBalanceConfirmationLine> CollectionModuleList = await ExecuteQueryAsync<IBalanceConfirmationLine>(sql, parameters);
                return CollectionModuleList;
            }
            catch (Exception ex)
            {
        ...
        public async Task<Winit.Modules.Contact.Model.Interfaces.IContact> GetContactDetails(string EmpCode)
        {
            try
            {
                ...
                var sql = @"Select c.*, s.uid FROM balance_confirmation bc 
                            INNER JOIN store s on s.uid = bc.org_uid 
                            INNER JOIN emp e on e.uid = bc.created_by
                            INNER JOIN contact c on c.linked_item_uid = bc.store_uid
                            Where e.code = @EmpCode";
                List<IContact> contactDetails = await ExecuteQueryAsync<IContact>(sql, parameters);
