...
{
    public class PGSQLAccPayableCMIDL : Base.DL.DBManager.PostgresDBManager, Interfaces.IAccPayableCMIDL
    {
        public PGSQLAccPayableCMIDL(IServiceProvider serviceProvider, IConfiguration config) : base(serviceProvider, config)
        {
