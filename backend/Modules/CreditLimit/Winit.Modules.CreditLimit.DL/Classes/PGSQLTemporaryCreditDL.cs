...
public class PGSQLTemporaryCreditDL : Winit.Modules.Base.DL.DBManager.PostgresDBManager, ITemporaryCreditDL
{
    public PGSQLTemporaryCreditDL(IServiceProvider serviceProvider, IConfiguration config) : base(serviceProvider, config)
    {
