...
namespace Winit.Modules.DashBoard.DL.Interfaces;
...
public interface IDashBoardDL
{
    ...
    Task<PagedResponse<IBranchSalesReport>> GetBranchSalesReport(List<SortCriteria> sortCriterias, int pageNumber, int pageSize,
        List<FilterCriteria> filterCriterias, bool isCountRequired, bool isForExport);
