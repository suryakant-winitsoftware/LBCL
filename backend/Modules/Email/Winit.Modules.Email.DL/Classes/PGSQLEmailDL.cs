...
{
    public class PGSQLEmailDL : Winit.Modules.Base.DL.DBManager.PostgresDBManager, IEmailDL
    {
        ...
        public PGSQLEmailDL(EmailUtility emailUtility, IServiceProvider serviceProvider, IConfiguration configuration, HttpClient httpClient) : base(serviceProvider, configuration)
        {
