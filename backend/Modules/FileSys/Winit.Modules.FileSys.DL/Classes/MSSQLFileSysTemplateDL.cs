...
{
    public  class MSSQLFileSysTemplateDL : Winit.Modules.Base.DL.DBManager.SqlServerDBManager, IFileSysTemplateDL
    {
        public MSSQLFileSysTemplateDL(IServiceProvider serviceProvider, IConfiguration config) : base(serviceProvider, config)
        {
