...
namespace Winit.Modules.Int_CommonMethods.BL.Classes
{
    public class int_CommonMethodsBL : Iint_CommonMethodsBL
    {
        protected readonly DL.Interfaces.IInt_CommonMethodsDL _int_CommonMethods;
        protected readonly IConfiguration _configuration;
        public int_CommonMethodsBL(DL.Interfaces.IInt_CommonMethodsDL int_CommonMethods, IConfiguration configuration)
        {
        ...
        public async Task<Model.Interfaces.IPrepareDB> GetTableScriptByEntity(List<FilterCriteria> filterCriterias)
        {
            return await _int_CommonMethods.GetTableScriptByEntity(filterCriterias);
        }
        public async Task<Model.Interfaces.IPrepareDB> GetTableScriptByEntity(string Entity)
        {
        ...
        public async Task<Winit.Modules.Int_CommonMethods.Model.Interfaces.IEntityDetails> FetchEntityDetails(string EntityName, long SyncLogId)
        {
            return await _int_CommonMethods.FetchEntityDetails(EntityName, SyncLogId);
        }
        public async Task<Winit.Modules.Int_CommonMethods.Model.Interfaces.IEntityData> GetEntityData(string EntityName)
        {
            return await _int_CommonMethods.GetEntityData(EntityName);
        }

        public async Task<string> InsertPendingData(Model.Interfaces.IPendingDataRequest pendingData)
        {
            return await _int_CommonMethods.InsertPendingData(pendingData);
        }
        public async Task<string> InsertPendingDataList(List<Model.Interfaces.IPendingDataRequest> pendingData)
        {
        ...
        public async Task<int> IntegrationProcessStatusInsertion(Model.Interfaces.IIntegrationMessageProcess integrationMessage)
        {
