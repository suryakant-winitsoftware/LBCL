...
{
    public class PGSQLint_CommonMethodsDL : SyncManagerDL.Base.DBManager.PostgresDBManager, IInt_CommonMethodsDL
    {
        private readonly Winit.Modules.Int_CommonMethods.DL.Classes.Int_ApiService _apiService;
        private readonly IConfiguration _configuration;
        private readonly string apiBaseUrl;
        public PGSQLint_CommonMethodsDL(IServiceProvider serviceProvider, IConfiguration config, Int_ApiService apiService) : base(serviceProvider, config)
        {
