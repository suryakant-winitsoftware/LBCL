...
public class MSSQLInvoiceDL : SqlServerDBManager, IInvoiceDL
{
    public IWalletDL _walletUpdaterDL;

    public MSSQLInvoiceDL(IServiceProvider serviceProvider, IConfiguration configuration, IWalletDL walletDL) : base(serviceProvider, configuration)
    {
