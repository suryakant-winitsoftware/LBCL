...
namespace Winit.Modules.Invoice.DL.Interfaces;
...
public interface IInvoiceDL
{
    ...
    Task<PagedResponse<IInvoiceApprove>> GetInvoiceApproveSatsusDetails(List<SortCriteria>? sortCriterias, int pageNumber,
   int pageSize, List<FilterCriteria>? filterCriterias, bool isCountRequired);
    ...
    Task<PagedResponse<IProvisionComparisonReportView>> GetProvisionComparisonReport(
