...
{
    public class MSSQLStoreHistoryDL : Winit.Modules.Base.DL.DBManager.SqlServerDBManager, Interfaces.IStoreHistoryDL
    {
        public MSSQLStoreHistoryDL(IServiceProvider serviceProvider, IConfiguration config) : base(serviceProvider, config)
        {
        }
