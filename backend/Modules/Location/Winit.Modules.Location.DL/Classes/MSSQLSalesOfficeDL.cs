...
{
    public class MSSQLSalesOfficeDL : Winit.Modules.Base.DL.DBManager.SqlServerDBManager, ISalesOfficeDL
    {
        public MSSQLSalesOfficeDL(IServiceProvider serviceProvider, IConfiguration config) : base(serviceProvider, config)
        {
