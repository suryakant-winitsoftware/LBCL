...
{
    public class PGSQLBranchDL : Winit.Modules.Base.DL.DBManager.PostgresDBManager, IBranchDL
    {
        public PGSQLBranchDL(IServiceProvider serviceProvider, IConfiguration config) : base(serviceProvider, config)
        {
