...
{
    public class PGSQLCityBranchMappingDL : Winit.Modules.Base.DL.DBManager.PostgresDBManager, ICityBranchMappingDL
    {
        public PGSQLCityBranchMappingDL(IServiceProvider serviceProvider, IConfiguration config) : base(serviceProvider, config)
        {
