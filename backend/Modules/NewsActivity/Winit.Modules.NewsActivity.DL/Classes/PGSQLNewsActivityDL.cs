...
{
    public class PGSQLNewsActivityDL : Winit.Modules.Base.DL.DBManager.PostgresDBManager, INewsActivityDL
    {
        public PGSQLNewsActivityDL(IServiceProvider serviceProvider, IConfiguration config) : base(serviceProvider, config)
        {
        }
