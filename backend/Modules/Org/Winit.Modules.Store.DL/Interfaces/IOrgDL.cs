...
namespace Winit.Modules.Org.DL.Interfaces
{
    public interface IOrgDL
    {
        ...
        Task<int> UpdateViewFranchiseeWarehouse(Winit.Modules.Org.Model.Interfaces.IEditWareHouseItemView updateWareHouseItemView);
        ...
        // Vanstock
        Task<IEnumerable<Winit.Modules.Org.Model.Interfaces.IWarehouseStockItemView>> GetVanStockItems(string warehouseUID, string orgUID,
            StockType? stockType);
        ...
        Task<PagedResponse<Winit.Modules.Org.Model.Interfaces.IWareHouseStock>> GetAllWareHouseStock(List<SortCriteria> sortCriterias, int pageNumber,
           int pageSize, List<FilterCriteria> filterCriterias, bool isCountRequired);
        Task<IEnumerable<Modules.SKU.Model.Interfaces.ISKUGroup>> GetSkuGroupBySkuGroupTypeUID(string skuGroupTypeUid);
