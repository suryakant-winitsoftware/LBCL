...
{
    public class PGSQLPlanogramV1DL : Winit.Modules.Base.DL.DBManager.PostgresDBManager, IPlanogramV1DL
    {
        public PGSQLPlanogramV1DL(IServiceProvider serviceProvider, IConfiguration config) : base(serviceProvider, config)
        {
        }
