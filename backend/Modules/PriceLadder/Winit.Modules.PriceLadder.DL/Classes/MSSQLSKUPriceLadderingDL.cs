...
public class MSSQLSKUPriceLadderingDL : Winit.Modules.Base.DL.DBManager.SqlServerDBManager, ISkuPriceLadderingDL
{
    public MSSQLSKUPriceLadderingDL(IServiceProvider serviceProvider, IConfiguration config) : base(serviceProvider, config)
    {
    }
