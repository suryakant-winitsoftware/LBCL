...
{
    public class MSSQLProductAttributesDL : Winit.Modules.Base.DL.DBManager.SqlServerDBManager, IProductAttributesDL
    {
        public MSSQLProductAttributesDL(IServiceProvider serviceProvider, IConfiguration config) : base(serviceProvider, config)
        {
        }
