...
{
    public class MSSQLProductConfigDL : Base.DL.DBManager.SqlServerDBManager, Interfaces.IProductConfigDL
    {
        public MSSQLProductConfigDL(IServiceProvider serviceProvider, IConfiguration config) : base(serviceProvider, config)
        {
        }
        ...
        {
            var sql = @"INSERT INTO ProductConfig(UID,CreatedBy,CreatedTime,ModifiedBy,ModifiedTime,ServerAddTime,ServerModifiedTime,ProductCode,
                      DistributionChannelOrgUID,CanBuy,CanSell,BuyingUOM,SellingUOM,IsActive)
