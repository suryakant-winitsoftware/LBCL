...
{
    public class PGSQLProductDimensionBridgeDL : Base.DL.DBManager.PostgresDBManager, Interfaces.IProductDimensionBridgeDL
    {
        public PGSQLProductDimensionBridgeDL(IServiceProvider serviceProvider, IConfiguration config) : base(serviceProvider, config)
        {
        }
