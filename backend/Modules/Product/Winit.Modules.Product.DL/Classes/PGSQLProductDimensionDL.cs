...
{
    public class PGSQLProductDimensionDL:Winit.Modules.Base.DL.DBManager.PostgresDBManager,IProductDimensionDL
    {
        public PGSQLProductDimensionDL(IServiceProvider serviceProvider, IConfiguration config) : base(serviceProvider, config)
        {
        }
