...
{
    public class PGSQLProductTypeBridgeDL : Base.DL.DBManager.PostgresDBManager, Interfaces.IProductTypeBridgeDL
    {
        public PGSQLProductTypeBridgeDL(IServiceProvider serviceProvider, IConfiguration config) : base(serviceProvider, config)
        {
        }
        public async Task<int> CreateProductTypeBridge(Model.Interfaces.IProductTypeBridge createProductTypeBridge)
        {
            var sql = @"INSERT INTO ""ProductTypeBridge"" (""UID"",""CreatedBy"",""CreatedTime"",""ModifiedBy"",""ModifiedTime"",""ServerAddTime"",
                      ""ServerModifiedTime"",""ProductCode"",""ProductTypeUID"") VALUES(@UID,@CreatedBy,@CreatedTime,@ModifiedBy,@ModifiedTime,@ServerAddTime,
                      @ServerModifiedTime,@ProductCode,@ProductTypeUID);";
