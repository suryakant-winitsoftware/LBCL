...
{
    public class PGSQLProductTypeDL : Winit.Modules.Base.DL.DBManager.PostgresDBManager, IProductTypeDL
    {
        public PGSQLProductTypeDL(IServiceProvider serviceProvider, IConfiguration config) : base(serviceProvider, config)
        {
