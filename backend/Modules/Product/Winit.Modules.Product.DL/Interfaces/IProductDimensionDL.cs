...
{
    public interface IProductDimensionDL
    {
        ...
        Task<int> CreateProductDimension(Winit.Modules.Product.Model.Interfaces.IProductDimension productDimension);
        Task<int> UpdateProductDimension(Winit.Modules.Product.Model.Interfaces.IProductDimension productDimension);
