...
public class MSSQLPurchaseOrderLineDL : Winit.Modules.Base.DL.DBManager.SqlServerDBManager, IPurchaseOrderLineDL
{
    ...
    public MSSQLPurchaseOrderLineDL(IServiceProvider serviceProvider, IConfiguration config,
