...
public class MSSQLPurchaseOrderLineProvisionDL : SqlServerDBManager, IPurchaseOrderLineProvisionDL
{

    public MSSQLPurchaseOrderLineProvisionDL(IServiceProvider serviceProvider, IConfiguration configuration) : base(serviceProvider, configuration)
    {
