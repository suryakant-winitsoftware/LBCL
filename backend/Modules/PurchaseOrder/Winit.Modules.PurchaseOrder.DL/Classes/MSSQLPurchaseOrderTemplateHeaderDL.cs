...
public class MSSQLPurchaseOrderTemplateHeaderDL : Winit.Modules.Base.DL.DBManager.SqlServerDBManager, IPurchaseOrderTemplateHeaderDL
{
    private readonly IPurchaseOrderTemplateLineDL _purchaseOrderTemplateLineDL;

    public MSSQLPurchaseOrderTemplateHeaderDL(IServiceProvider serviceProvider, IConfiguration config, IPurchaseOrderTemplateLineDL purchaseOrderTemplateLineDL)
