...
public class MSSQLPurchaseOrderTemplateLineDL : Winit.Modules.Base.DL.DBManager.SqlServerDBManager, IPurchaseOrderTemplateLineDL
{
    public MSSQLPurchaseOrderTemplateLineDL(IServiceProvider serviceProvider, IConfiguration config)
