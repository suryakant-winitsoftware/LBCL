...
{
    public class MSSQLTaxSKUMapDL : Winit.Modules.Base.DL.DBManager.SqlServerDBManager, ITaxSkuMapDL
    {
        public MSSQLTaxSKUMapDL(IServiceProvider serviceProvider, IConfiguration config) : base(serviceProvider, config)
        {
        }
        ...
        public async Task<Winit.Modules.SKU.Model.Interfaces.ITaxSkuMap> SelectTaxSkuMapByUID(string UID)
        {
            ...
            return await ExecuteSingleAsync<Winit.Modules.SKU.Model.Interfaces.ITaxSkuMap>(sql, parameters);
        ...
        public async Task<int> CreateTaxSkuMap(Winit.Modules.SKU.Model.Interfaces.ITaxSkuMap taxSkuMap)
        {
            try
            {
                ...
                return await ExecuteNonQueryAsync(sql, taxSkuMap);
            }
            catch (Exception)
            {
                throw;
