...
{
    public class PGSQLSKUTemplateDL : Winit.Modules.Base.DL.DBManager.PostgresDBManager, ISKUTemplateDL
    {
        public PGSQLSKUTemplateDL(IServiceProvider serviceProvider, IConfiguration config) : base(serviceProvider, config)
        {
        }
            ...
            try
            {
                       var sql = @"UPDATE sku_template
                        SET
                            ...
                            is_active = @IsActive,
                            sku_template_data = @SKUTemplateData :: json
                        WHERE
                            uid = @UID;";
                string skuTemplateDataJson = JsonConvert.SerializeObject(sKUTemplate.SKUTemplateData);
                sKUTemplate.SKUTemplateData = skuTemplateDataJson;
