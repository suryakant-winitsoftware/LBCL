...
{
    public class PGSQLSKUToGroupMappingDL : Winit.Modules.Base.DL.DBManager.PostgresDBManager,ISKUToGroupMappingDL
    {
        public PGSQLSKUToGroupMappingDL(IServiceProvider serviceProvider, IConfiguration config) : base(serviceProvider, config)
        {
        }
