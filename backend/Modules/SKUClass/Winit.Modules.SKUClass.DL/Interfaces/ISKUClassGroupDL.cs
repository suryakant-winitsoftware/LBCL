...
{
    public interface ISKUClassGroupDL
    {
        ...
        Task<int> CreateSKUClassGroup(Winit.Modules.SKUClass.Model.Interfaces.ISKUClassGroup createSKUClassGroup, IDbConnection? connection = null, IDbTransaction? transaction = null);
        Task<int> UpdateSKUClassGroup(Winit.Modules.SKUClass.Model.Interfaces.ISKUClassGroup updateSKUClassGroup, IDbConnection? connection = null, IDbTransaction? transaction = null);
