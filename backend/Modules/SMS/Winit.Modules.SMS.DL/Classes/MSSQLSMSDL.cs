...
{
    public class MSSQLSMSDL : Winit.Modules.Base.DL.DBManager.SqlServerDBManager, ISMSDL
    {
        private readonly IConfiguration _configuration;
        private readonly HttpClient _httpClient;
        private string? SmsApiUrl { get; set; }
        private string? SmsKey { get; set; }
        public MSSQLSMSDL(IServiceProvider serviceProvider, IConfiguration configuration, HttpClient httpClient) : base(serviceProvider, configuration)
        {
