...
public class CashSalesOrderViewModel : SalesOrderWebViewModel
{
    public CashSalesOrderViewModel(IServiceProvider serviceProvider,
               ...
               dataManager, orderLevelCalculator, cashDiscountCalculator, appConfigs, salesOrderDataHelper)
    {
        ...
        OrderType = Shared.Models.Constants.OrderType.Cashsales;
    }
    public override async Task<bool> SaveSalesOrder(string statusType = SalesOrderStatus.DRAFT)
    {
        ...
        {
            IStoreHistory storeHistory = await _salesOrderDataHelper.GetStoreHistoryAPI(RouteUID, CommonFunctions.GetDateOnlyInFormatForSqlite(ExpectedDeliveryDate), StoreUID);
