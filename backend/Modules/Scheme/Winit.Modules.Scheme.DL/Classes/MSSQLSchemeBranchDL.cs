...
{
    public class MSSQLSchemeBranchDL : SqlServerDBManager, ISchemeBranchDL
    {
        public MSSQLSchemeBranchDL(IServiceProvider serviceProvider, IConfiguration config) : base(serviceProvider, config)
        {
        }
