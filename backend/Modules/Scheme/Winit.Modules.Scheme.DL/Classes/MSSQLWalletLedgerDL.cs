...
{
    public class MSSQLWalletLedgerDL : SqlServerDBManager,IWalletLedgerDL
    {
       public MSSQLWalletLedgerDL(IServiceProvider serviceProvider, IConfiguration config) : base(serviceProvider, config) { }
