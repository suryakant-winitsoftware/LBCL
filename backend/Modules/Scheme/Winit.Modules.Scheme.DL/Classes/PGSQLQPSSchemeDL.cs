...
{
    public class PGSQLQPSSchemeDL : PostgresDBManager, IQPSSchemeDL
    {
        private readonly IApprovalEngineHelper _approvalEngineHelper;
        public PGSQLQPSSchemeDL(IApprovalEngineHelper approvalEngineHelper, IServiceProvider serviceProvider, IConfiguration config) : base(serviceProvider, config)
        {
