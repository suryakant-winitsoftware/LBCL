...
{
    public class PGSQLSchemeBroadClassificationDL : PostgresDBManager, ISchemeBroadClassificationDL
    {
        public PGSQLSchemeBroadClassificationDL(IServiceProvider serviceProvider, IConfiguration config) : base(serviceProvider, config)
        {
        }
