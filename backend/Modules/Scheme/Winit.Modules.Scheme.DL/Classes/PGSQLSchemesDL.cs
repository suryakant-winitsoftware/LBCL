...
{
    public class PGSQLSchemesDL : PostgresDBManager, ISchemesDL
    {
        private readonly IApprovalEngineHelper _approvalEngineHelper;
        public PGSQLSchemesDL(IServiceProvider serviceProvider, IConfiguration config, IApprovalEngineHelper approvalEngineHelper) : base(serviceProvider, config)
        {
