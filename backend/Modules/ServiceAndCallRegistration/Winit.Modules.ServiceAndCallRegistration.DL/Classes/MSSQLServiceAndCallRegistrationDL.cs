...
{
    public class MSSQLServiceAndCallRegistrationDL : Base.DL.DBManager.SqlServerDBManager, IServiceAndCallRegistrationDL
    {
        public MSSQLServiceAndCallRegistrationDL(IServiceProvider serviceProvider, IConfiguration config) : base(serviceProvider, config)
        {
