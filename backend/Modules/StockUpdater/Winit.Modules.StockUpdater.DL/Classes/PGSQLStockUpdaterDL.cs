...
{
    public class PGSQLStockUpdaterDL : Winit.Modules.Base.DL.DBManager.PostgresDBManager, IStockUpdaterDL
    {
        public PGSQLStockUpdaterDL(IServiceProvider serviceProvider, IConfiguration config) : base(serviceProvider, config)
        {
        }
        public async Task<int> UpdateStockAsync(List<IWHStockLedger> stockLedgers, IDbConnection? connection = null, IDbTransaction? transaction = null)
        {
            ...
            if (connection == null)
            {
                using (connection = PostgreConnection())
                {
            ...
            IDbConnection? connection = null, IDbTransaction? transaction = null)
         {
            ...
            try
            {
                ...
                INSERT INTO wh_stock_ledger (
                    uid, ss, created_by, created_time, modified_by, modified_time, server_add_time, server_modified_time, company_uid, warehouse_uid,
                    ...
                    @uid, 0, @createdBy, @createdTime, @modifiedBy, @modifiedTime, @serverAddTime, @serverModifiedTime, @companyUid, @warehouseUid,
                ...
                retValue = await ExecuteNonQueryAsync(salesOrderQuery, connection, transaction, wHStockLedger);
                if (retValue > 0)
                {
            ...
            object connection = null, object transaction = null)
        {
            ...
            try
            {
                returnValue = await ExecuteNonQueryAsync(query, (NpgsqlConnection)connection, (NpgsqlTransaction)transaction, parameters);
            }
            catch (Exception ex)
            {
                throw;
            ...
            object connection = null, object transaction = null)
        {
            ...
            string query = string.Format(@"INSERT INTO wh_stock_available (uid, ss, created_by, created_time, modified_by, 
                ...
                VALUES(@UID, 0, @CreatedBy, @CreatedTime, @ModifiedBy, 
