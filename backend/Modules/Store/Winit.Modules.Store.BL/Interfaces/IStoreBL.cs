...
namespace Winit.Modules.Store.BL.Interfaces
{
    public interface IStoreBL
    {
        ...
        Task<List<Winit.Modules.Store.Model.Interfaces.IStoreMaster>> PrepareStoreMaster(List<string> storeUIDs);
        ...
        Task<PagedResponse<IStoreCustomer>> GetAllStoreItems(List<SortCriteria> sortCriterias, int pageNumber,
            int pageSize,
            List<FilterCriteria> filterCriterias, bool isCountRequired, string OrgUID);
