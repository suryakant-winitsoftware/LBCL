...
{
    public class PGSQLStoreAsmMappingDL : PostgresDBManager, IStoreAsmMappingDL
    {
        public PGSQLStoreAsmMappingDL(IServiceProvider serviceProvider, IConfiguration config)
