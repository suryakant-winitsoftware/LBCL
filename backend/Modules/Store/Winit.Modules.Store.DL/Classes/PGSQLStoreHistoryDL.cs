...
public class PGSQLStoreHistoryDL : PostgresDBManager, IStoreHistoryDL
{
    public PGSQLStoreHistoryDL(IServiceProvider serviceProvider, IConfiguration configuration) : base(serviceProvider, configuration)
    {
