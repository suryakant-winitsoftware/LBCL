...
namespace Winit.Modules.Store.DL.Classes
{
    public class SQLiteStoreCreditDL : Base.DL.DBManager.SqliteDBManager, Interfaces.IStoreCreditDL
    {
        ...
        public async Task<int> CreateStoreCredit(Model.Interfaces.IStoreCredit storeCredit)
        {
            try
            {
                var sql = @"INSERT INTO store_credit (id, uid, created_by, created_time, modified_by, modified_time, server_add_time,
                            ...
                            is_allow_cash_on_credit_exceed, is_outstanding_bill_control, is_negative_invoice_allowed) VALUES (@Id, @UID, @CreatedBy, @CreatedTime, @ModifiedBy,
