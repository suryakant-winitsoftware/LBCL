...
{
    public class PGSQLTallyMasterDL : Winit.Modules.Base.DL.DBManager.PostgresDBManager, ITallyMasterDL
    {
        public PGSQLTallyMasterDL(IServiceProvider serviceProvider, IConfiguration config) : base(serviceProvider, config)
        {
        }
