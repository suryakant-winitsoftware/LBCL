...
{
    public class SKUPriceDataHelper : ISKUPriceDataHelper
    {
        ApiService _apiService;
        IAppConfig _appConfigs;
        CommonFunctions _commonFunctions;
        public SKUPriceDataHelper(ApiService apiService, IAppConfig appConfig, CommonFunctions commonFunctions)
        {
        ...
        public async Task GetAllProducts()
        {
            ...
            Winit.Shared.Models.Common.ApiResponse<PagedResponse<Winit.Modules.SKU.Model.Interfaces.ISKUV1>> apiResponse = 
                await _apiService.FetchDataAsync<PagedResponse<Winit.Modules.SKU.Model.Interfaces.ISKUV1>>(
        ...
        public async Task<int> SaveUpdateOrDelete(string responseMethod, HttpMethod httpMethod, object obj = null)
        {
            int count = 0;
        ...
        public async Task<ApiResponse<string>> CUD_SKUPrice(string responseMethod, HttpMethod httpMethod, object obj = null)
        {
