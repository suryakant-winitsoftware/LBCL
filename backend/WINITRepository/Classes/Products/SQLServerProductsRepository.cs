...
{
    public class SQLServerProductsRepository: Interfaces.Products.IProductRepository
    {
        private readonly string _connectionString;
        public SQLServerProductsRepository(IConfiguration config)
        {
            _connectionString = config.GetConnectionString("SqlServer");
        }
        public async Task<IEnumerable<WINITSharedObjects.Models.Product>> GetProductsAll()
        {
            DBManager.SqlServerDBManager<WINITSharedObjects.Models.Product> dbManager = new DBManager.SqlServerDBManager<WINITSharedObjects.Models.Product>(_connectionString);
        ...
        public async Task<WINITSharedObjects.Models.Product> GetProductByProductCode(string productCode)
        {
            ...
            WINITSharedObjects.Models.Product Products = await dbManager.ExecuteSingleAsync(sql, parameters);
            return await Task.FromResult(Products);
        }
        public async Task<WINITSharedObjects.Models.Product> CreateProduct(WINITSharedObjects.Models.Product Product)
        {
            DBManager.SqlServerDBManager<Product> dbManager = new DBManager.SqlServerDBManager<Product>(_connectionString);
            
            var sql = "INSERT INTO Product ([CreatedBy], [CreatedTime],  [ModifiedBy],[ModifiedTime],[ServerAddTime],[ServerModifiedTime],[org_code],[product_name],[product_code],[is_active],[BaseUOM])" +
                " VALUES (@CreatedBy, @CreatedTime, @ModifiedBy,@ModifiedTime, @ServerAddTime,@ServerModifiedTime,@org_code,@product_name,@product_code,@is_active,@BaseUOM);";
            Dictionary<string, object> parameters = new Dictionary<string, object>
            {
        ...
        public async Task<int> UpdateProduct( Product UpdateProduct)
        {
            try
            {
                ...
                var sql = "UPDATE Product SET [ModifiedBy] = @ModifiedBy, [ModifiedTime] = @ModifiedTime, [ServerModifiedTime] = @ServerModifiedTime," +
                    " [org_code] = @org_code,[product_name] = @product_name,[is_active] = @is_active,[BaseUOM] = @BaseUOM WHERE [product_code] = @product_code;";
                Dictionary<string, object> parameters = new Dictionary<string, object>
                {
        ...
        public async Task<IEnumerable<WINITSharedObjects.Models.Product>> GetProductsSorted(List<WINITSharedObjects.Enums.SortCriteria> sortCriterias)
        {
            ...
            IEnumerable<WINITSharedObjects.Models.Product> ProductsList = await dbManager.ExecuteQueryAsync(sql.ToString(), sortParameters);
        ...
        public async Task<IEnumerable<WINITSharedObjects.Models.ProductConfig>> GetProductConfigAll()
        {
            ...
            try
            {
                DBManager.SqlServerDBManager<WINITSharedObjects.Models.ProductConfig> dbManager = new DBManager.SqlServerDBManager<WINITSharedObjects.Models.ProductConfig>(_connectionString);
        ...
        {
            DBManager.SqlServerDBManager<ProductConfig> dbManager = new DBManager.SqlServerDBManager<ProductConfig>(_connectionString);
        ...
        {
            DBManager.SqlServerDBManager<WINITSharedObjects.Models.ProductUOM> dbManager = new DBManager.SqlServerDBManager<WINITSharedObjects.Models.ProductUOM>(_connectionString);
        ...
        {
            DBManager.SqlServerDBManager<ProductUOM> dbManager = new DBManager.SqlServerDBManager<ProductUOM>(_connectionString);
            ...
            try
            {
                ...
                var sql = "INSERT INTO ProductUOM (CreatedBy, CreatedTime, ModifiedBy,ModifiedTime,ServerAddTime,ServerModifiedTime,ProductCode,Code" +
                    ",Name,Label,BarCode,IsBaseUOM,IsOuterUOM,Multiplier) VALUES (@CreatedBy, @CreatedTime, @ModifiedBy,@ModifiedTime,@ServerAddTime,@ServerModifiedTime,@ProductCode," +
        ...
        {
            DBManager.SqlServerDBManager<WINITSharedObjects.Models.ProductAttributes> dbManager = new DBManager.SqlServerDBManager<WINITSharedObjects.Models.ProductAttributes>(_connectionString);
        ...
        {
            DBManager.SqlServerDBManager<ProductDimensionBridge> dbManager = new DBManager.SqlServerDBManager<ProductDimensionBridge>(_connectionString);

            try
            {
                var sql = "INSERT INTO ProductDimensionBridge (CreatedBy, CreatedTime, ModifiedBy,ModifiedTime,ServerAddTime,ServerModifiedTime,product_code) VALUES" +
              " (@CreatedBy, @CreatedTime, @ModifiedBy,@ModifiedTime,@ServerAddTime,@ServerModifiedTime,@product_code)";
                Dictionary<string, object> parameters = new Dictionary<string, object>
            {
        ...
        {
            DBManager.SqlServerDBManager<WINITSharedObjects.Models.ProductDimensionBridge> dbManager = new DBManager.SqlServerDBManager<WINITSharedObjects.Models.ProductDimensionBridge>(_connectionString);
        ...
        {
            DBManager.SqlServerDBManager<ProductTypeBridge> dbManager = new DBManager.SqlServerDBManager<ProductTypeBridge>(_connectionString);
        ...
        {
            DBManager.SqlServerDBManager<WINITSharedObjects.Models.ProductTypeBridge> dbManager = new DBManager.SqlServerDBManager<WINITSharedObjects.Models.ProductTypeBridge>(_connectionString);
        ...
        {
            DBManager.SqlServerDBManager<WINITSharedObjects.Models.ProductType> dbManager = new DBManager.SqlServerDBManager<WINITSharedObjects.Models.ProductType>(_connectionString);
            try
            {
                Dictionary<string, object> parameters = new Dictionary<string, object>
                {
        ...
        {
            DBManager.SqlServerDBManager<ProductType> dbManager = new DBManager.SqlServerDBManager<ProductType>(_connectionString);
        ...
        public async Task<int> UpdateProductType( ProductType UpdateProductType)
        {
            try
            {
                ...
                var sql = "UPDATE ProductType SET ModifiedBy=@ModifiedBy,ModifiedTime=@ModifiedTime,product_group_type=@product_group_type,ServerModifiedTime=@ServerModifiedTime," +
                    "product_type_code=@product_type_code, product_type_description=@product_type_description   WHERE product_type_id=@product_type_id";
                Dictionary<string, object> parameters = new Dictionary<string, object>
                {
        ...
        {
            DBManager.SqlServerDBManager<WINITSharedObjects.Models.ProductDimension> dbManager = new DBManager.SqlServerDBManager<WINITSharedObjects.Models.ProductDimension>(_connectionString);
        ...
        {
            DBManager.SqlServerDBManager<ProductDimension> dbManager = new DBManager.SqlServerDBManager<ProductDimension>(_connectionString);
        ...
        public async Task<int> UpdateProductDimension(ProductDimension UpdateProductDimension)
        {
            try
            {
                ...
                var sql = "UPDATE ProductDimension SET ModifiedBy=@ModifiedBy,ModifiedTime=@ModifiedTime,ServerModifiedTime=@ServerModifiedTime," +
                    "product_dimension_code=@product_dimension_code, product_dimension_description=@product_dimension_description   WHERE product_dimension_id=@product_dimension_id";
                Dictionary<string, object> parameters = new Dictionary<string, object>
                {
        ...
        public async Task<IEnumerable<WINITSharedObjects.Models.ProductDimension>> GetProductDimensionPaged(int pageNumber, int pageSize)
        {
            DBManager.SqlServerDBManager<WINITSharedObjects.Models.ProductDimension> dbManager = new DBManager.SqlServerDBManager<WINITSharedObjects.Models.ProductDimension>(_connectionString);
            Dictionary<string, object> parameters = new Dictionary<string, object>();
            var sql = "SELECT * FROM ProductDimension ORDER BY (SELECT NULL) OFFSET @Offset ROWS FETCH NEXT @Limit ROWS ONLY";
            parameters.Add("Offset", (pageNumber - 1) * pageSize);
            parameters.Add("Limit", pageSize);
            IEnumerable<WINITSharedObjects.Models.ProductDimension> ProductDimensionList = await dbManager.ExecuteQueryAsync(sql, parameters);
            return await Task.FromResult(ProductDimensionList);
        ...
        //retrival and fiter and sorting and pagination

    //    public async Task<IEnumerable<WINITSharedObjects.Models.Product>> AllGetProduct(List<WINITSharedObjects.Enums.SortCriteria> sortCriterias, int pageNumber,
    ...
    //                for (var i = 0; i < sortCriterias.Count; i++)
    //                {
    //                    var paramName = $"sortParam{i}";
    //                    sql.Append($"[{sortCriterias[i].SortParameter}] {(sortCriterias[i].Direction == SortDirection.Asc ? "ASC" : "DESC")}");
    ...
    //            {
    //                // Apply pagination using OFFSET FETCH
    //                sql.Append($" OFFSET {((pageNumber - 1) * pageSize)} ROWS FETCH NEXT {pageSize} ROWS ONLY");
    //            }

    //            IEnumerable<WINITSharedObjects.Models.Product> productList = await dbManager.ExecuteQueryAsync(sql.ToString(), parameters);
