...
namespace WINITRepository.Interfaces.Holiday
{
...
//int pageSize, List<FilterCriteria> filterCriterias);
   ...
   int pageSize, List<FilterCriteria> filterCriterias);
        ...
        Task<WINITSharedObjects.Models.Holiday> CreateHoliday(WINITSharedObjects.Models.Holiday createHoliday);
        ...
        Task<int> UpdateHolidayListRole(WINITSharedObjects.Models.HolidayListRole updateHolidayList);
