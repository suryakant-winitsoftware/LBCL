...
namespace WINITServices.Interfaces
{
    public interface IProductService
    {
        ...
        Task<WINITSharedObjects.Models.Product> CreateProduct(Product Product);
        //Task<int> UpdateProduct(string product_code, Product UpdateProduct);
        Task<int> UpdateProduct( Product UpdateProduct);
