...
{
    public partial class CustomerDetails : BaseComponentBase
    {
       ...
       [
        ...
        {
            Console.WriteLine(_appUser.SelectedJobPosition.UID);
            //await SetHeaderName();
        ...
        public async Task OnDeleteUsersClick(IOnBoardGridview customerUID)
        {
            ...
            if (result > 0)
            {
                ...
                await _alertService.ShowSuccessAlert("Delete", "Customer Deleted Successfully");
            }
            else
            {
