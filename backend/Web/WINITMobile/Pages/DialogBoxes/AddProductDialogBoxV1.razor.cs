...
namespace WINITMobile.Pages.DialogBoxes
{
    public partial class AddProductDialogBoxV1<T> 
    {
        ...
        [Parameter]
        public Winit.Shared.Models.Enums.SelectionMode SelectionMode { get; set; } = Winit.Shared.Models.Enums.SelectionMode.Multiple;
        ...
        private void OnItemSelect(T item, ChangeEventArgs e)
        {
            ...
            if ((bool)e.Value!)
            {
                if (SelectionMode == Winit.Shared.Models.Enums.SelectionMode.Single)
                {
                    SelectedItems.Clear();
                }
