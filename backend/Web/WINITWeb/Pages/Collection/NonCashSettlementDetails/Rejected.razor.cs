    ...
    public partial class Rejected
    {
        ...
        protected override async Task OnInitializedAsync()
        {
            try
            {
                ...
                await _rejectPaymentViewModel.GetChequeDetails(UID, TargetUID);
                bank = _rejectPaymentViewModel.Bank;
        ...
        public async Task SetHeaderName()
        {
            ...
            _IDataService.BreadcrumList.Add(new BreadCrum.Classes.BreadCrumModel() { SlNo = 3, Text = @Localizer["rejected_collections"], IsClickable = false });
            _IDataService.HeaderText = @Localizer["rejected_collections"];
