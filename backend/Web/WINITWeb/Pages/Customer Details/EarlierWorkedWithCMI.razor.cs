...
{
    public partial class EarlierWorkedWithCMI
    {
        ...
        public async Task SaveOrUpdate()
        {
            ...
            {
                _tost.Add(OnboardingScreenConstant.EarlierWorkWithCMI, "Selection cannot be Empty", Winit.UIComponents.SnackBar.Enum.Severity.Error);
                return;
            }
