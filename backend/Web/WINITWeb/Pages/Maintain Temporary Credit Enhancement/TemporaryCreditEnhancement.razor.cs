...
public partial class TemporaryCreditEnhancement : BaseComponentBase
{
    ...
    private async Task StateChageHandler()
    {
        ...
        bool stateRestored = _pageStateHandler.RestoreState("TemporaryCreditEnhancement", ref FilterColumns, out PageState pageState);
    ...
    {
        _navigationManager.LocationChanged -= (sender, args) => SavePageState();
        _pageStateHandler.SaveCurrentState("TemporaryCreditEnhancement");
    }
