...
public partial class ManageInvoice
{
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        [
            ...
            new DataGridColumn { Header = "Oracle Order No", IsSortable = true,GetValue = s => ((IInvoiceHeaderView)s).OraclePONumber  ?? "N/A", SortField="oracleponumber"    },
    ...
    private async Task StateChageHandler()
    {
        ...
        bool stateRestored = _pageStateHandler.RestoreState("manageinvoice", ref FilterColumns, out PageState pageState);
    ...
    {
        _navigationManager.LocationChanged -= (sender, args) => SavePageState();
        _pageStateHandler.SaveCurrentState("manageinvoice");
    }
    private void PrepareFilterData()
    {
        FilterColumns.AddRange(
            new List<FilterModel>
            {
                ...
                new() {FilterType = Winit.Shared.Models.Constants.FilterConst.TextBox, Label = "Oracle Order No",
