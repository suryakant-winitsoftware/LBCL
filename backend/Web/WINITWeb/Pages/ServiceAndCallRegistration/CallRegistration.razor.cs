...
namespace WinIt.Pages.ServiceAndCallRegistration
{
    public partial class CallRegistration :BaseComponentBase
    {
        ...
        {
            HeaderText = "Call Registration",
            BreadcrumList = new List<IBreadCrum>()
            {
                new BreadCrumModel(){SlNo=1,Text="Call Registration"},
            }
        };
        ...
        private async Task SaveCallRegistrationDetailsAndFileSys()
        {
            ...
            {
                ShowSuccessSnackBar("Success","Call Registration Successful.");
                NavigationManager.NavigateTo("MaintainCallRegistration" );
                
            }
            else
            {
                ShowErrorSnackBar("Error", string.Join(",", _serviceAndCallRegistrationViewModel.CallRegistrationResponce.Errors));
            }
        }
