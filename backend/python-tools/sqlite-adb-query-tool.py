...
class SQLiteADBQueryTool:
    def __init__(self, package_name: str = "com.multiplexmobilecli", db_name: str = "WINITSQLite.db"):
        """
...
Examples:
  ...
  python sqlite-adb-query-tool.py --export users --output users.csv
    ...
    parser.add_argument('--package', default='com.multiplexmobilecli',
                       help='Android package name (default: com.multiplexmobilecli)')
