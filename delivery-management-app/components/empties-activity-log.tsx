...
import { PhysicalCountModal } from "@/components/physical-count-modal"
import { RateAgentModal } from "@/components/rate-agent-modal"
...
export function EmptiesActivityLog() {
  ...
  const steps: ActivityStep[] = [
    ...
    { id: 7, title: "Send Empty Detail Acknowledgement Note to Agent", completed: false },
  ]
  ...
  return (
    <>
      <div className="min-h-screen bg-gray-50">
        ...
        <header className="bg-white border-b border-gray-200 px-4 py-4 sticky top-0 z-10">
          <div className="flex items-center justify-between">
            ...
            <h1 className="text-lg font-bold text-gray-900 text-center flex-1">
              Empties Receiving Activity Log Report
            </h1>
            <div className="w-10" />
          </div>
        </header>
        ...
        <div className="bg-white p-4 border-b border-gray-200">
          <div className="grid grid-cols-5 gap-4">
            <div>
              <div className="text-xs text-gray-500 mb-1">Empties Delivery No</div>
            ...
            <div>
              <div className="text-xs text-gray-500 mb-1">Agent Departure Time</div>
            ...
            {leftColumnSteps.map((step) => (
              <div key={step.id} className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                ...
                >
                  ...
                  {step.id === 1 && <FileText className="w-5 h-5 text-red-600" />}
                  {step.expandable && (
                    <ChevronDown
                  ...
                  {!step.expandable && step.id !== 1 && <ChevronRight className="w-5 h-5 text-gray-400" />}
                </button>
                  ...
                  <div className="px-4 pb-4 space-y-4 border-t border-gray-200 pt-4">
                        ...
                        <div className="flex gap-2">
                          <div className="relative flex-1">
                            <input
                              ...
                              defaultValue="19"
                            />
                            <span className="absolute right-3 top-1/2 -translate-y-1/2 text-xs text-gray-400">HH</span>
                          </div>
                          <div className="relative flex-1">
                            <input
                              type="number"
                    ...
                    <div className="flex items-center gap-2">
                      <div className="relative">
                        <input type="checkbox" id="notify" className="peer sr-only" defaultChecked />
                        <label
                          htmlFor="notify"
            ...
            {rightColumnSteps.map((step) => (
              <div key={step.id} className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                ...
                >
                  ...
                  {!step.expandable && <ChevronRight className="w-5 h-5 text-gray-400" />}
                </button>
                ...
                {step.id === 6 && expandedStep === 6 && (
                  <div className="px-4 pb-4 space-y-4 border-t border-gray-200 pt-4">
                    <div className="space-y-4">
                      <div>
                        <label className="text-sm text-gray-600 mb-2 block">LBCL Fork Lift Operator</label>
                        <select className="w-full px-3 py-2 border border-gray-300 rounded-lg bg-white">
      ...
      {showPhysicalCount && <PhysicalCountModal onClose={() => setShowPhysicalCount(false)} />}
      {showRateAgent && <RateAgentModal onClose={() => setShowRateAgent(false)} />}
    </>
  )
}
