    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          title: "Stock History",
          icon: History,
          path: "/stock-receiving/history",
          description: "View stock history",
        },
        {
          title: "Timeline Stamps",
          icon: Clock,
          path: "/stock-receiving/timeline",
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          icon: Package,
          path: "/truck-loading/collection",
          description: "Collect loaded items",
        },
        {
          title: "Activity Log",
          icon: Clock,
          path: "/truck-loading/activity-log",
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          title: "Activity Log",
          icon: Clock,
          path: "/empties-receiving/activity-log",
                    ...
                    <div className="flex-1 text-left">
                      <div
                        className={`font-semibold ${
                          isActive ? "text-[#A08B5C]" : "text-gray-900"
                        }`}
                      >
                        {item.title}
                      </div>
                        ...
                        return (
                          <button
                            ...
                            className={`w-full flex items-start gap-3 pl-16 pr-6 py-3 hover:bg-gray-100 transition-colors ${
                              isChildActive
                                ? "bg-[#FFF8E7] border-l-4 border-[#A08B5C]"
                                : ""
                            }`}
                          >
                            <div
