    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white border-b border-gray-200 px-4 py-4 sticky top-0 z-10">
        <div className="flex items-center justify-between">
          <NavigationMenu />
          <h1 className="text-lg sm:text-xl font-bold text-gray-900 flex-1 text-center">RD Truck Loading Request</h1>
          <div className="flex items-center gap-2">
            <span className="text-sm font-bold text-gray-900">25 May 2025</span>
      ...
      <div className="bg-white border-b border-gray-200 px-4 py-4">
        <div className="max-w-7xl mx-auto grid grid-cols-5 gap-4 text-sm">
          ...
          <div>
            <div className="text-xs text-gray-500 mb-1">Vehicle Capacity Limit</div>
            <div className="font-bold text-gray-900">45 m3</div>
          </div>
          <div>
            <div className="text-xs text-gray-500 mb-1">Total Number of Litres</div>
          ...
          <table className="w-full">
            <thead className="bg-[#FFF8E7]">
              <tr>
                ...
                <th className="px-4 py-3 text-center text-xs font-medium text-gray-700 min-w-[120px]">Pre Order Qty</th>
                <th className="px-4 py-3 text-center text-xs font-medium text-gray-700 min-w-[150px]">Buffer Qty</th>
                <th className="px-4 py-3 text-center text-xs font-medium text-gray-700 min-w-[120px]">Loadable Qty</th>
                <th className="px-4 py-3 text-center text-xs font-medium text-gray-700 min-w-[120px]">Balance Qty</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-200">
              {products.map((product) => (
                <tr key={product.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-4 py-4 text-center">
                    <div className="font-medium text-gray-900">{product.preOrderQty}</div>
                  </td>
                  <td className="px-4 py-4">
                    <div className="flex items-center justify-center gap-2">
                      <button className="w-10 h-10 border border-gray-300 rounded-lg flex items-center justify-center hover:bg-gray-50">
                        {product.bufferQty > 0 ? <Minus className="w-4 h-4" /> : <Plus className="w-4 h-4" />}
                      </button>
                      <button className="w-10 h-10 border border-gray-300 rounded-lg flex items-center justify-center hover:bg-gray-50">
                  ...
                  <td className="px-4 py-4 text-center">
                    <div className="font-medium text-gray-900">{product.balanceQty}</div>
                  </td>
                </tr>
              ))}
            </tbody>
