...
const DeliveryLogin = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const result = await login(username, password, 'delivery')
      ...
      <div className="min-h-screen flex">
        ...
        <div className="hidden lg:flex lg:w-1/2 bg-blue-600 p-12 items-center justify-center">
          <div className="max-w-md text-center">
            <div className="mb-8">
              <div className="w-16 h-16 bg-white border-2 border-gray-900 rounded-lg flex items-center justify-center mx-auto mb-4">
            ...
            <div className="text-white mb-8">
              <p className="text-lg mb-4 font-semibold">Delivery Management Portal</p>
              <div className="space-y-3 text-sm">
                <div className="flex items-center justify-center gap-3">
                  <div className="w-2 h-2 bg-white rounded-full"></div>
                  <span>Track delivery plans and logistics</span>
                </div>
                <div className="flex items-center justify-center gap-3">
                  <div className="w-2 h-2 bg-white rounded-full"></div>
                  <span>Manage activity logs and reports</span>
                </div>
                <div className="flex items-center justify-center gap-3">
                  <div className="w-2 h-2 bg-white rounded-full"></div>
        ...
        <div className="flex-1 flex items-center justify-center p-6 lg:p-12">
          <div className="w-full max-w-md">
            ...
            <div className="lg:hidden text-center mb-8">
              <div className="w-12 h-12 bg-blue-600 border-2 border-gray-900 rounded-lg flex items-center justify-center mx-auto mb-4">
                <span className="text-white text-2xl font-bold">L</span>
              </div>
              <h2 className="text-gray-900 text-2xl font-bold">LION</h2>
              <p className="text-gray-600 text-sm">Delivery Portal</p>
            </div>

            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              {/* Header */}
              <div className="text-center mb-6">
                <h2 className="text-2xl font-bold text-gray-900 mb-2">Delivery Login</h2>
                <p className="text-gray-600">Sign in to your delivery management account</p>
              </div>
              ...
              <form onSubmit={handleLogin} className="space-y-4">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-3 px-4 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-400 text-white font-semibold rounded-lg transition-all duration-200 flex items-center justify-center gap-2 mt-6"
                >
                  {loading ? (
                    <>
