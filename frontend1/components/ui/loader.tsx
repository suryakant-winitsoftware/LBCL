  ...
  "flex items-center justify-center",
  {
    variants: {
      variant: {
        ...
        ghost: "text-[var(--accent-foreground)]",
        link: "text-[var(--primary)]",
        white: "text-[var(--primary-foreground)]",
      },
      size: {
        default: "h-8 w-8",
        sm: "h-4 w-4",
          ...
          {showText && text && (
            <div className="space-y-2">
              <p className={cn(
                ...
                size === "lg" && "text-base",
                size === "xl" && "text-lg",
                variant === "white" ? "text-[var(--primary-foreground)]" : "text-[var(--foreground)]"
              )}>
                {text}
              </p>
...
>(({ text = "Loading...", className, variant = "primary", ...props }, ref) => (
  <div className={cn("fixed inset-0 z-50 flex items-center justify-center", className)}>
    ...
    <div className="absolute inset-0 bg-[var(--background)]/95 backdrop-blur-sm" />
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "before:from-transparent before:via-[var(--primary)]/10 before:to-transparent",
        className
      )}
      {...props}
    />
