...
import { Search, RefreshCw, Eye, Edit, ChevronLeft, ChevronRight, Plus, MoreHorizontal } from 'lucide-react';
    ...
    <div className="container mx-auto p-6">
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-2">
          Manage and configure tax groups for your organization
        </p>
      </div>
                      ...
                      <TableCell className="text-right">
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            ...
                            <DropdownMenuItem
                              onClick={() => router.push(`/administration/tax-configuration/tax-groups/edit/${group.UID}`)}
                            >
