...
export default function PromotionReportsPage() {
  ...
  const handleCreateNew = () => {
    router.push(
      "/productssales/promotions/manage?create=true"
    );
  };
  ...
  const handleViewPromotion = (promotionId: string) => {
    router.push(
      `/productssales/promotions/${promotionId}`
    );
  };
            ...
            <CardHeader>
              <CardTitle className="flex items-center justify-between">
                ...
                <Badge variant="secondary">
                  {stats.upcomingPromotions.length}
                </Badge>
              </CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center justify-between">
                ...
                <Badge variant="secondary">
                  {stats.expiringPromotions.length}
                </Badge>
              </CardTitle>
            </CardHeader>
            <CardContent>
                ...
                >
                  ...
                  <div className="flex items-center space-x-3">
                    <div className="text-right">
                      ...
                      <p className="text-xs text-gray-400">
                        Priority: {promotion.Priority || "N/A"}
                      </p>
                    </div>
                    {getStatusBadge(promotion)}
                    <ChevronRight className="h-4 w-4 text-gray-400" />
