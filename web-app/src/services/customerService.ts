...
export const customerService = {
  ...
  async getAllCustomers(): Promise<Customer[]> {
    try {
      const response = await apiService.get("/Customer/SelectAllCustomers");
  ...
  async getCustomersPaged(params: PagingRequest) {
    try {
      const response = await apiService.get("/Customer/GetCustomersPaged", {
        params: {
  ...
  async getCustomersFiltered(filter: string): Promise<Customer[]> {
    try {
      const response = await apiService.get("/Customer/GetCustomersFiltered", {
        params: { filter }
      });
      return response?.data || [];
    } catch (error) {
  ...
  async getCustomerByUID(uid: string): Promise<Customer | null> {
    try {
      const response = await apiService.get("/Customer/SelectCustomerByUID", {
        params: { UID: uid }
      });
  ...
  async deleteCustomer(uid: string) {
    try {
      const response = await apiService.delete("/Customer/DeleteCustomer", {
        params: { UID: uid }
      });
      return response?.data;
    } catch (error) {
