...
class JourneyPlanService {
  ...
  ): Promise<PagedResponse<RouteSchedule>> {
  ...
  async getRouteScheduleByRouteUID(routeUID: string): Promise<RouteSchedule> {
    ...
    console.warn(
      "RouteSchedule API not implemented - returning default schedule"
    );
    return Promise.resolve({
  ...
  async createRouteSchedule(scheduleData: RouteSchedule): Promise<any> {
    ...
    console.warn(
      "RouteSchedule API not implemented - skipping schedule creation"
    );
  ...
  async updateRouteSchedule(scheduleData: RouteSchedule): Promise<any> {
    ...
    // Fallback: Return success for now
    console.warn(
      "RouteSchedule API not implemented - skipping schedule update"
    );
  ...
  async deleteRouteSchedule(uid: string): Promise<any> {
    ...
    // Fallback: Return success for now
    console.warn(
      "RouteSchedule API not implemented - skipping schedule deletion"
    );
    return Promise.resolve({ IsSuccess: true });
  }

  // Route Schedule Daywise Methods - DISABLED: Backend endpoints not yet implemented
  async getRouteScheduleDaywise(
    routeScheduleUID: string
  ): Promise<RouteScheduleDaywise> {
    ...
    console.warn(
      "RouteScheduleDaywise API not implemented - returning default daywise schedule"
    );
    return Promise.resolve({
  ...
  async createRouteScheduleDaywise(
    daywiseData: RouteScheduleDaywise
  ): Promise<any> {
    // return apiService.post('/RouteSchedule/CreateRouteScheduleDaywise', daywiseData);
    // Fallback: Return success for now
    console.warn(
      "RouteScheduleDaywise API not implemented - skipping daywise creation"
    );
    return Promise.resolve({ IsSuccess: true, Data: daywiseData.UID });
  }

  async updateRouteScheduleDaywise(
    daywiseData: RouteScheduleDaywise
  ): Promise<any> {
    // return apiService.post('/RouteSchedule/UpdateRouteScheduleDaywise', daywiseData);
    // Fallback: Return success for now
    console.warn(
      "RouteScheduleDaywise API not implemented - skipping daywise update"
    );
    return Promise.resolve({ IsSuccess: true });
  }
  ...
  async getStoreHistoryStats(
    storeHistoryUID: string
  ): Promise<StoreHistoryStats[]> {
    return apiService.get(
      `/StoreHistory/GetStoreHistoryStatsByUID?StoreHistoryUID=${storeHistoryUID}`
    );
  }
  ...
  async createStoreHistoryStats(statsData: StoreHistoryStats): Promise<any> {
    ...
    console.warn(
      "StoreHistoryStats creation endpoint not implemented - returning mock success"
    );
    return Promise.resolve({
      IsSuccess: true,
      Data: 1,
      Message: "StoreHistoryStats creation simulated"
    });
  }
  ...
  async getRouteCustomers(routeUID: string): Promise<RouteCustomer[]> {
    return apiService.get(
      `/Route/GetRouteCustomersByRouteUID?RouteUID=${routeUID}`
    );
  }
  ...
  async updateRouteCustomerSequence(
    routeUID: string,
    customerSequences: { StoreUID: string; SeqNo: number }[]
  ): Promise<any> {
  ...
  async getStoreHistories(
    request: PagedRequest
  ): Promise<PagedResponse<StoreHistoryComplete>> {
    return apiService.post(
      "/StoreHistory/SelectAllStoreHistoryDetails",
      request
    );
  }

  async getStoreHistoryByBeatHistoryUID(
    beatHistoryUID: string
  ): Promise<StoreHistoryComplete[]> {
    return apiService.get(
      `/StoreHistory/GetStoreHistoryByBeatHistoryUID?BeatHistoryUID=${beatHistoryUID}`
    );
  }

  async createStoreHistory(
    storeHistoryData: StoreHistoryComplete
  ): Promise<any> {
    // return apiService.post('/StoreHistory/CreateStoreHistory', storeHistoryData);
    console.warn(
      "StoreHistory creation endpoint not implemented - returning mock success"
    );
    return Promise.resolve({
      IsSuccess: true,
      Data: 1,
      Message: "StoreHistory creation simulated"
    });
  }

  async createMultipleStoreHistories(
  ...
  async updateStoreHistory(
    storeHistoryData: StoreHistoryComplete
  ): Promise<any> {
    return apiService.post(
      "/StoreHistory/UpdateStoreHistory",
      storeHistoryData
    );
  }
  ...
  async deleteUserJourney(uid: string): Promise<any> {
    ...
    console.log(
      `🗑️ JourneyPlanService: Using CASCADE HARD DELETE for user journey: ${uid}`
    );
  ...
  async deleteJourneyPlan(uid: string): Promise<any> {
    try {
      console.log(
        `🗑️ JourneyPlanService: Starting BACKEND-COMPATIBLE HARD DELETE for journey plan: ${uid}`
      );
      ...
      console.log(
        `⚠️  GetCustomersByBeatHistoryUID - Not implemented (500 error)`
      );
      console.log(
        `⚠️  UserJourney deletion endpoints - Not found (404 errors)`
      );
      console.log(`⚠️  StoreHistory deletion endpoints - Unknown status`);
      console.log(
        `❌ Main DeleteBeatHistory - Failing due to foreign key constraints`
      );
...
because related StoreHistory and UserJourney records exist.
      ...
      console.error(
        "❌ JourneyPlanService: HARD DELETE FAILED - Backend API Issues:",
        error
      );
      throw error;
    }
  ...
  async forceHardDeleteJourneyPlan(uid: string): Promise<any> {
    ...
    try {
      ...
      try {
        ...
        for (const getEndpoint of endpoints) {
          try {
            ...
            if (relatedData && relatedData.Data) {
              const records = Array.isArray(relatedData.Data)
                ? relatedData.Data
                : [relatedData.Data];
              ...
              for (const record of records) {
                if (record && (record.UID || record.Id)) {
                  ...
                  const deleteEndpoints = [
                    () =>
                      apiService.delete(
                        `/StoreHistory/DeleteStoreHistory?UID=${recordUID}`
                      ),
                    () =>
                      apiService.delete(
                        `/BeatHistory/DeleteStoreHistory?UID=${recordUID}`
                      ),
                    () =>
                      apiService.delete(
                        `/UserJourney/DeleteUserJourney?UID=${recordUID}`
                      )
                  ];
                  ...
                  for (const deleteEndpoint of deleteEndpoints) {
                    try {
                      ...
                      deleteLog.hardDeletedRecords.push(
                        `✓ HARD DELETED: ${recordUID}`
                      );
                      console.log(
                        `🗑️ HARD DELETED related record: ${recordUID}`
                      );
        ...
        deleteLog.errors.push(
          `Could not search for related records: ${searchError.message}`
        );
      }
      ...
      for (const deleteMethod of mainDeleteMethods) {
        try {
          ...
          console.log(
            `🗑️ HARD DELETED main BeatHistory record using method ${
              mainDeleteMethods.indexOf(deleteMethod) + 1
            }`
          );
      ...
      if (!mainDeleted) {
        throw new Error(
          `HARD DELETE FAILED: Could not physically remove BeatHistory record ${uid} from database`
        );
      }
      ...
      throw new Error(
        `HARD DELETE FAILED: ${error.message}. Record may still exist in database.`
      );
    }
  }
  ...
  async cascadeDeleteJourneyPlan(uid: string): Promise<any> {
    try {
      console.log(
        `JourneyPlanService: Starting cascade delete for journey plan: ${uid}`
      );
      ...
      try {
        const relatedStoreHistories =
          await this.getStoreHistoryByBeatHistoryUID(uid);
        if (relatedStoreHistories && relatedStoreHistories.length > 0) {
          console.log(
            `Found ${relatedStoreHistories.length} StoreHistory records to delete`
          );
          ...
          for (const storeHistory of relatedStoreHistories) {
            try {
              ...
              deleteResults.errors.push(
                `Failed to delete StoreHistory ${storeHistory.UID}: ${error.message}`
              );
              console.warn(
                `✗ Failed to delete StoreHistory ${storeHistory.UID}:`,
                error
              );
            }
          }
        ...
        deleteResults.errors.push(
          `Failed to retrieve StoreHistory records: ${error.message}`
        );
      ...
      try {
        ...
        console.log(
          "Skipping UserJourney deletion (no API available for BeatHistoryUID lookup)"
        );
      } catch (error) {
        deleteResults.errors.push(
          `Failed to delete UserJourney records: ${error.message}`
        );
      }
      ...
      try {
        ...
        deleteResults.errors.push(
          `Failed to delete main BeatHistory record: ${error.message}`
        );
      ...
      return {
        IsSuccess:
          deleteResults.mainRecordDeleted && deleteResults.errors.length === 0,
        Data: deleteResults,
  ...
  async getJourneyPlans(request: PagedRequest): Promise<PagedResponse<any>> {
    console.log(
      "🎯 JourneyPlanService: Using CORRECT API - BeatHistory/SelectAllJobPositionDetails for journey plan data"
    );
    return api.beatHistory.selectAll(request);
  }
  ...
  async createCompleteJourneyPlan(journeyPlanData: {
    ...
    try {
      ...
      const beatHistoryResponse = await this.createBeatHistory(
        journeyPlanData.beatHistory
      );
      ...
      const storeHistoriesWithPlanning = journeyPlanData.storeHistories.map(
        (history, index) => ({
          ...history,
      ...
      const storeHistoryResponse = await this.createMultipleStoreHistories(
        storeHistoriesWithPlanning
      );
  ...
  async finalizeJourneyPlan(
    ...
    // });
    console.warn(
      "Journey Plan finalize API not implemented - returning success"
    );
    return Promise.resolve({
      IsSuccess: true,
      Message: "Journey Plan finalized (simulated)"
    });
  }
  ...
  async activateJourneyPlan(beatHistoryUID: string): Promise<any> {
    ...
    // });
    console.warn(
      "Journey Plan activate API not implemented - returning success"
    );
    return Promise.resolve({
      IsSuccess: true,
      Message: "Journey Plan activated (simulated)"
    });
  }

  async suspendJourneyPlan(
    beatHistoryUID: string,
    reason: string
  ): Promise<any> {
    ...
    // });
    console.warn(
      "Journey Plan suspend API not implemented - returning success"
    );
    return Promise.resolve({
      IsSuccess: true,
      Message: "Journey Plan suspended (simulated)"
    });
  }
  ...
  async getJourneyPlanStatus(beatHistoryUID: string): Promise<any> {
    ...
    console.warn(
      "Journey Plan status API not implemented - returning default status"
    );
    return Promise.resolve({
      IsSuccess: true,
      Data: {
  ...
  async copyJourneyPlan(
    sourceBeatHistoryUID: string,
    targetDate: string,
    targetRouteUID?: string
  ): Promise<any> {
    ...
    return Promise.resolve({
      IsSuccess: true,
      Message: "Journey Plan copied (simulated)"
    });
  }

  // DISABLED: Template APIs not yet implemented
  async getJourneyPlanTemplate(
    routeUID: string,
    ...
    console.warn(
      "Journey Plan template API not implemented - returning empty template"
    );
    return Promise.resolve({
      IsSuccess: true,
      Data: {
  ...
  async saveJourneyPlanAsTemplate(
    beatHistoryUID: string,
    templateName: string
  ): Promise<any> {
    ...
    // });
    console.warn(
      "Save Journey Plan template API not implemented - returning success"
    );
    return Promise.resolve({
      IsSuccess: true,
      Message: "Template saved (simulated)"
    });
  }
  ...
  async getJourneyPlanAnalytics(params: {
    ...
    console.warn(
      "Journey Plan analytics API not implemented - returning mock data"
    );
    return Promise.resolve({
      IsSuccess: true,
      Data: {
  ...
  async getRoutePerformanceReport(
    ...
    console.warn(
      "Route performance report API not implemented - returning mock data"
    );
    return Promise.resolve({
      IsSuccess: true,
      Data: {
  ...
  async getJourneyPlanComplianceReport(params: {
    ...
    console.warn(
      "Journey Plan compliance report API not implemented - returning mock data"
    );
    return Promise.resolve({
      IsSuccess: true,
      Data: {
  ...
  async validateJourneyPlanData(
    ...
    if (
      !journeyPlanData.selectedCustomersWithTimes ||
      journeyPlanData.selectedCustomersWithTimes.length === 0
    ) {
    ...
    if (journeyPlanData.selectedCustomersWithTimes) {
      const invalidTimes = journeyPlanData.selectedCustomersWithTimes.filter(
        (customer: any) =>
          !customer.startTime ||
          !customer.endTime ||
          customer.visitDuration <= 0
      );
      if (invalidTimes.length > 0) {
        errors.push(
          "All customers must have valid start time, end time, and visit duration"
        );
      }
    }
  ...
  transformBeatHistoryToJourney(apiData: any): UserJourney {
    ...
    return {
      ...
      EmpUID:
        apiData.JobPositionUID || apiData.LoginId || apiData.CreatedBy || "", // Use JobPositionUID for display
      JourneyStartTime: apiData.VisitDate || apiData.CreatedTime, // Use VisitDate for the journey date
      ...
      VehicleUID: apiData.VehicleUID || "", // Keep VehicleUID for actual vehicle
      RouteUID: apiData.RouteUID || "", // Use RouteUID properly
      ...
      WhStockRequestUID: "",
      LoginId:
        apiData.JobPositionUID || apiData.LoginId || apiData.CreatedBy || "", // Show JobPositionUID in Employee ID column
      ...
      CreatedTime: apiData.VisitDate || apiData.CreatedTime, // Use VisitDate as primary date
  ...
  // Export functionality for User Journeys
  async exportUserJourneys(
    format: "csv" | "excel",
    filters?: { search?: string; eotStatus?: string; attendanceStatus?: string }
  ): Promise<Blob> {
    try {
      // Build request to get all journey plans (using same API as the grid)
      const request: PagedRequest = {
        pageNumber: 0, // Use 0-based pagination like the grid
        pageSize: 10000, // Get up to 10,000 journeys
        filterCriterias: [],
        sortCriterias: [],
        isCountRequired: true
      };

      // Use the same API endpoint as the JourneyPlanGrid (BeatHistory)
      const response = await this.getJourneyPlans(request);
      
      if (!response?.IsSuccess || !response.Data?.PagedData) {
        console.log("No journey data found or API request failed");
        return this.exportUserJourneysToCSV([]);
      }

      console.log("=== USER JOURNEY EXPORT DEBUG ===");
      console.log("Raw data from API:", response.Data.PagedData.length, "records");
      
      // Transform using the same transformation as the grid
      let journeyData = response.Data.PagedData.map((journey: any) =>
        this.transformBeatHistoryToJourney(journey)
      );
      
      console.log("Transformed journey data:", journeyData.length, "records");

      // Apply client-side filtering if provided (same logic as the grid)
      if (filters?.search) {
        const searchLower = filters.search.toLowerCase();
        const beforeFilter = journeyData.length;
        journeyData = journeyData.filter((journey: any) =>
          journey.LoginId?.toLowerCase().includes(searchLower) ||
          journey.JobPositionUID?.toLowerCase().includes(searchLower) ||
          journey.EmpUID?.toLowerCase().includes(searchLower)
        );
        console.log(`Search filter applied: ${beforeFilter} -> ${journeyData.length} records`);
      }

      if (filters?.eotStatus && filters.eotStatus !== 'all' && filters.eotStatus !== '') {
        const beforeFilter = journeyData.length;
        journeyData = journeyData.filter((journey: any) => 
          journey.EOTStatus === filters.eotStatus
        );
        console.log(`EOT Status filter applied: ${beforeFilter} -> ${journeyData.length} records`);
      }

      if (filters?.attendanceStatus && filters.attendanceStatus !== 'all' && filters.attendanceStatus !== '') {
        const beforeFilter = journeyData.length;
        journeyData = journeyData.filter((journey: any) => 
          journey.AttendanceStatus === filters.attendanceStatus
        );
        console.log(`Attendance Status filter applied: ${beforeFilter} -> ${journeyData.length} records`);
      }

      console.log("Final filtered journey data for export:", journeyData.length, "records");
      console.log("===============================");

      if (format === "csv") {
        return this.exportUserJourneysToCSV(journeyData);
      } else {
        return this.exportUserJourneysToExcel(journeyData);
      }
    } catch (error) {
      console.error("Failed to export user journeys:", error);
      throw new Error("Failed to export user journeys");
    }
  }

  // Export functionality for Journey Plans (Today's Plans)
  async exportJourneyPlans(
    format: "csv" | "excel",
    filters?: { visitDate?: Date | null; jobPositionUID?: string; orgUID?: string }
  ): Promise<Blob> {
    try {
      // Build request to get journey plans (using beat history endpoint)
      const request: PagedRequest = {
        pageNumber: 0, // Use 0-based pagination
        pageSize: 10000, // Get up to 10,000 plans
        isCountRequired: true,
        sortCriterias: [],
        filterCriterias: []
      };
      ...
      let filteredPlans = responseData;

      // Apply filters
      if (filters?.visitDate) {
        const selectedDate = new Date(filters.visitDate).toISOString().split('T')[0];
        filteredPlans = filteredPlans.filter((plan: any) => {
          const visitDate = plan.visit_date || plan.VisitDate || plan.visitDate;
          if (visitDate) {
            const planDate = new Date(visitDate).toISOString().split('T')[0];
      ...
      if (filters?.jobPositionUID) {
        filteredPlans = filteredPlans.filter((plan: any) => {
          ...
          return jobPositionUID === filters.jobPositionUID;
        });
      }
      ...
      const transformedPlans = filteredPlans.map((plan: any) => {
        ...
        return {
          ...
          HasAuditCompleted: hasAuditCompleted
        };
      });

      if (format === "csv") {
        return this.exportJourneyPlansToCSV(transformedPlans);
      } else {
        return this.exportJourneyPlansToExcel(transformedPlans);
      }
    } catch (error) {
      console.error("Failed to export journey plans:", error);
      throw new Error("Failed to export journey plans");
    }
  }

  private exportUserJourneysToCSV(journeys: UserJourney[]): Blob {
    const headers = [
      "Job Position UID",
      "Employee UID",
      "Login ID",
    ...
    const csvContent = [
      ...
      ...journeys.map(journey => [
        `"${journey.JobPositionUID || ''}"`,
        `"${journey.EmpUID || ''}"`,
        `"${journey.LoginId || ''}"`,
        `"${journey.JourneyStartTime ? new Date(journey.JourneyStartTime).toLocaleString() : ''}"`,
        `"${journey.JourneyEndTime ? new Date(journey.JourneyEndTime).toLocaleString() : ''}"`,
        `"${journey.JourneyTime || ''}"`,
        `"${journey.StartOdometerReading || 0}"`,
        `"${journey.EndOdometerReading || 0}"`,
        `"${journey.VehicleUID || ''}"`,
        `"${journey.EOTStatus || ''}"`,
        `"${journey.AttendanceStatus || ''}"`,
        `"${journey.AttendanceAddress || ''}"`,
        `"${journey.BatteryPercentageTarget || 100}"`,
        `"${journey.BatteryPercentageAvailable || 100}"`,
        `"${journey.HasInternet ? 'Yes' : 'No'}"`,
        `"${journey.InternetType || ''}"`,
        `"${journey.DownloadSpeed || 0}"`,
        `"${journey.UploadSpeed || 0}"`,
        `"${journey.HasMobileNetwork ? 'Yes' : 'No'}"`,
        `"${journey.IsLocationEnabled ? 'Yes' : 'No'}"`,
        `"${journey.IsSynchronizing ? 'Yes' : 'No'}"`,
        `"${journey.HasAuditCompleted ? 'Yes' : 'No'}"`,
        `"${journey.CreatedBy || ''}"`,
        `"${journey.CreatedTime ? new Date(journey.CreatedTime).toLocaleDateString() : ''}"`,
        `"${journey.ModifiedBy || ''}"`,
        `"${journey.ModifiedTime ? new Date(journey.ModifiedTime).toLocaleDateString() : ''}"`
      ].join(","))
    ].join("\n");
  ...
  private exportJourneyPlansToCSV(plans: any[]): Blob {
    const headers = [
      "Visit Date",
      "Route UID",
      "Route Name",
    ...
    const csvContent = [
      headers.join(","),
      ...plans.map(plan => [
        `"${plan.VisitDate ? new Date(plan.VisitDate).toLocaleDateString() : ''}"`,
        `"${plan.RouteUID || ''}"`,
        `"${plan.RouteName || ''}"`,
        `"${plan.OrgUID || ''}"`,
        `"${plan.JobPositionUID || ''}"`,
        `"${plan.EmpUID || ''}"`,
        `"${plan.PlannedStoreVisits || 0}"`,
        `"${plan.ActualStoreVisits || 0}"`,
        `"${plan.SkippedStoreVisits || 0}"`,
        `"${plan.UnPlannedStoreVisits || 0}"`,
        `"${plan.Coverage || 0}"`,
        `"${plan.Status || ''}"`,
        `"${plan.InvoiceStatus || ''}"`,
        `"${plan.HasAuditCompleted ? 'Yes' : 'No'}"`
      ].join(","))
    ].join("\n");
  ...
  private exportUserJourneysToExcel(journeys: UserJourney[]): Blob {
    const csvContent = this.exportUserJourneysToCSV(journeys);
    return new Blob([csvContent], { 
      type: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet;charset=utf-8;' 
    });
  }

  private exportJourneyPlansToExcel(plans: any[]): Blob {
    const csvContent = this.exportJourneyPlansToCSV(plans);
    return new Blob([csvContent], { 
      type: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet;charset=utf-8;' 
    });
  }
