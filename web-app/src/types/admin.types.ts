...
export interface Role {
  ...
  Code: string
  RoleNameEn: string
  RoleNameOther?: string // Alias name
  ParentRoleUid?: string // Parent role UID  
  ...
  IsActive: boolean
  HaveWarehouse?: boolean // Warehouse access
  HaveVehicle?: boolean // Vehicle access
  IsForReportsTo?: boolean // Reports to access
  CreatedBy?: string
  CreatedTime?: string
  ModifiedBy?: string
  ModifiedTime?: string
